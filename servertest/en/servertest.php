		...
		<tr>
			...
			<td id="main">
				...
				<div id="content">
					...
					Your system has been checked for compatibility with b1gMail.
					...
					<table class="list">
						...
						<tr>
							<th>PHP version</th>
							<td>5.2, 5.4 recommended</td>
							<td><?php echo(phpversion()); ?></td>
							<td><img src="servertest.php?file=<?php if(PHPNumVersion() >= 540) { echo 'ok'; } else if(PHPNumVersion() >= 520) { echo 'warning'; $phpBelow54 = true; } else { echo 'error'; $testOK = false; } ?>.png" border="0" alt="" width="16" height="16" /></td>
						</tr>
						<tr>
							<th>MySQL support</th>
							<td>Yes</td>
							<td><?php echo(function_exists('mysql_connect') || function_exists('mysqli_connect') ? 'Yes' : 'No'); ?></td>
						...
						<tr>
							<th>GD extension</th>
							<td>Yes / No</td>
							<td><?php echo(function_exists('imagecreate') ? 'Yes' : 'No'); ?></td>
						...
						<tr>
							...
							<td>Yes / No</td>
							<td><?php echo(function_exists('openssl_pkcs7_verify') ? 'Yes' : 'No'); ?></td>
						...
						<tr>
							...
							<td>Module / CGI</td>
							<td><?php echo(function_exists('apache_get_version') ? 'Module' : 'CGI'); ?></td>
					...
					<ul>
						<li>b1gMail will<br />
							...
							<?php echo($testOK
									? ($gdError ? 'work on your server, but will not be able to display some statistics and captcha graphics'
												: 'work on your server without limitations')
									: 'will not work on your server properly'); ?></strong>
							<br /><br /></li>
						<?php if($testOK) { ?><li>The optional features 
							<a title="Interfaces to use the Webdisk from within the Explorer or Finder and to synchronize calendar and address book" class="glossary">WebDAV/CalDAV/CardDAV</a> are<br />
							...
							<br /><br /></li>
						<li>The optional <a title="Email encryption/decryption and signing" class="glossary">S/MIME</a> features are<br />
							<strong><img src="servertest.php?file=<?php echo(!$smimeError ? 'ok' : 'warning'); ?>.png" border="0" alt="" width="16" height="16" align="absmiddle" />
							<?php echo(!$smimeError
									? 'available'
									: 'not available (require PHP version 5.2.0 or greater with OpenSSL extension)'); ?></strong>
							<br /></li><?php } ?>
					</ul>
					
					<small>
						<b>Notice:</b> This Server Test script cannot check if you have enough space available,
										if your provider supports catchall POP3 accounts and if you have a MySQL
										database with enough space available. If you are in doubt, please ask
										your web hoster if your webspace supports the official
										<a href="https://www.b1gmail.com/en/faq/#faq-10" target="_blank">system requirements</a>.
					</small>
