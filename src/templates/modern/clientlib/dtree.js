...
function dTree(objName) {
	...
	this.icon = {
		...
		plusBottom	: 'fa fa-caret-right',

		minus				: 'fa fa-caret-down',

		minusBottom	: 'fa fa-caret-down',

		nlPlus			: 'fa fa-caret-right',

		nlMinus			: 'fa fa-caret-down'
...
dTree.prototype.node = function(node, nodeId) {
	...
	/*	if (this.root.id == node.pid) {
		...
		str += '<i class="' + ((node._io) ? node.iconOpen : node.icon) + '" id="i' + this.obj + nodeId + '" /></i>&nbsp;';
