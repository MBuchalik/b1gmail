...
<form name="f1" method="post" action="organizer.addressbook.php?action={if isset($contact) && $contact}saveContact&id={$contact.id}{else}createContact{/if}&sid={$sid}" onsubmit="return(checkContactForm(this));">
	...
	<table class="listTable">
		...
		<tr>
			...
			<td class="listTableRight">
				<select name="anrede" id="anrede">
					<option value=""{if isset($contact) && $contact.anrede==''} selected="selected"{/if}>&nbsp;</option>
		...
		<tr>
			...
			<td class="listTableRight">
				<input type="text" name="vorname" id="vorname" value="{text value=$contact.vorname|default:'' allowEmpty=true}" size="20" />
				<input type="text" name="nachname" id="nachname" value="{text value=$contact.nachname|default:'' allowEmpty=true}" size="20" />
			</td>
		</tr>
		...
		<tr>
			...
			<td class="listTableRight">
				<input type="text" name="strassenr" id="strassenr" value="{text value=$contact.strassenr|default:'' allowEmpty=true}" size="30" />
			</td>
		</tr>
		<tr>
			<td class="listTableLeft"><label for="plz">{lng p="zipcity"}:</label></td>
			<td class="listTableRight">
				<input type="text" name="plz" id="plz" value="{text value=$contact.plz|default:'' allowEmpty=true}" size="6" />
				<input type="text" name="ort" id="ort" value="{text value=$contact.ort|default:'' allowEmpty=true}" size="20" />
			</td>
		</tr>
		<tr>
			<td class="listTableLeft"><label for="land">{lng p="country"}:</label></td>
			<td class="listTableRight">	
				<input type="text" name="land" id="land" value="{text value=$contact.land|default:'' allowEmpty=true}" size="30" />
			</td>
		</tr>
		<tr>
			<td class="listTableLeft"><label for="email">{lng p="email"}:</label></td>
			<td class="listTableRight">	
				<input type="text" name="email" id="email" value="{if isset($smarty.request.email) && $smarty.request.email}{text value=$smarty.request.email}{else}{text value=$contact.email|default:'' allowEmpty=true}{/if}" size="30" />
			</td>
		</tr>
		<tr>
			<td class="listTableLeft"><label for="tel">{lng p="phone"}:</label></td>
			<td class="listTableRight">	
				<input type="text" name="tel" id="tel" value="{text value=$contact.tel|default:'' allowEmpty=true}" size="30" />
			</td>
		</tr>
		<tr>
			<td class="listTableLeft"><label for="fax">{lng p="fax"}:</label></td>
			<td class="listTableRight">	
				<input type="text" name="fax" id="fax" value="{text value=$contact.fax|default:'' allowEmpty=true}" size="30" />
			</td>
		</tr>
		<tr>
			<td class="listTableLeft"><label for="handy">{lng p="mobile"}:</label></td>
			<td class="listTableRight">	
				<input type="text" name="handy" id="handy" value="{text value=$contact.handy|default:'' allowEmpty=true}" size="30" />
			</td>
		</tr>
				...
				<table width="100%" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td align="right">
							...
							<input type="radio" name="default" id="default_work" value="work"{if isset($contact) && $contact.default_address==2} checked="checked"{/if} />
						</td>
					</tr>
				</table></td>
		</tr>
		<tr>
			...
			<td class="listTableRight">
				<input type="text" name="work_strassenr" id="work_strassenr" value="{text value=$contact.work_strassenr|default:'' allowEmpty=true}" size="30" />
			</td>
		</tr>
		<tr>
			<td class="listTableLeft"><label for="work_plz">{lng p="zipcity"}:</label></td>
			<td class="listTableRight">
				<input type="text" name="work_plz" id="work_plz" value="{text value=$contact.work_plz|default:'' allowEmpty=true}" size="6" />
				<input type="text" name="work_ort" id="work_ort" value="{text value=$contact.work_ort|default:'' allowEmpty=true}" size="20" />
			</td>
		</tr>
		<tr>
			<td class="listTableLeft"><label for="work_land">{lng p="country"}:</label></td>
			<td class="listTableRight">	
				<input type="text" name="work_land" id="work_land" value="{text value=$contact.work_land|default:'' allowEmpty=true}" size="30" />
			</td>
		</tr>
		<tr>
			<td class="listTableLeft"><label for="work_email">{lng p="email"}:</label></td>
			<td class="listTableRight">	
				<input type="text" name="work_email" id="work_email" value="{text value=$contact.work_email|default:'' allowEmpty=true}" size="30" />
			</td>
		</tr>
		<tr>
			<td class="listTableLeft"><label for="tel">{lng p="phone"}:</label></td>
			<td class="listTableRight">	
				<input type="text" name="work_tel" id="work_tel" value="{text value=$contact.work_tel|default:'' allowEmpty=true}" size="30" />
			</td>
		</tr>
		<tr>
			<td class="listTableLeft"><label for="fax">{lng p="fax"}:</label></td>
			<td class="listTableRight">	
				<input type="text" name="work_fax" id="work_fax" value="{text value=$contact.work_fax|default:'' allowEmpty=true}" size="30" />
			</td>
		</tr>
		<tr>
			<td class="listTableLeft"><label for="work_handy">{lng p="mobile"}:</label></td>
			<td class="listTableRight">	
				<input type="text" name="work_handy" id="work_handy" value="{text value=$contact.work_handy|default:'' allowEmpty=true}" size="30" />
			</td>
		</tr>
		...
		<tr>
			...
			<td class="listTableRight"><input type="text" name="firma" id="firma" value="{text value=$contact.firma|default:'' allowEmpty=true}" size="30" /></td>
		</tr>
		<tr>
			<td class="listTableLeft"><label for="position">{lng p="position"}</label>:</td>
			<td class="listTableRight">
				<input type="text" name="position" id="position" value="{text value=$contact.position|default:'' allowEmpty=true}" size="30" />
			</td>
		</tr>
		<tr>
			<td class="listTableLeft"><label for="web">{lng p="web"}:</label></td>
			<td class="listTableRight">	
				<input type="text" name="web" id="web" value="{text value=$contact.web|default:'' allowEmpty=true}" size="30" />
			</td>
		</tr>
		<tr>
			<td class="listTableLeft">{lng p="birthday"}:</td>
			<td class="listTableRight">	
				{if isset($contact.geburtsdatum) && $contact.geburtsdatum}
		...
		<tr>
			...
			<td class="listTableRight">	
				<textarea class="textInput" name="kommentar" id="kommentar">{text value=$contact.kommentar|default:'' allowEmpty=true}</textarea>
			</td>
		</tr>
		<tr>
