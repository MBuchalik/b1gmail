...
class PremiumAccountPlugin extends BMPlugin {
    ...
    function OnReadLang(
        ...
        $_lang_custom = $_lang_user = $_lang_client = $_lang_admin = [];
        ...
        if ($lang == 'deutsch') {
            ...
            // custom
            $_lang_custom['pacc_nm_subject'] =
                'Ihr Account-Abo läuft in Kürze ab';
            $_lang_custom['pacc_nm_text'] =
            ...
            $_lang_user['pacc_signup_aborted'] =
                'Die Registrierung wurde abgebrochen und Ihre Benutzerdaten wurden verworfen. Wir danken Ihnen dennoch f&uuml;r Ihr Interesse an unseren Dienstleistungen.<br />Sie k&ouml;nnen sich gerne jederzeit erneut anmelden. Sollten Sie Fragen haben, z&ouml;gern Sie nicht, uns zu kontaktieren.';
            $_lang_user['pacc_locktext'] =
            ...
            $_lang_user['pacc_forcetext'] =
                'Bitte w&auml;hlen Sie nun das Leistungs-Paket aus, das Sie erwerben m&ouml;chten. Informationen zu verf&uuml;gbaren Paketen und deren Preisen finden Sie in der folgenden Tabelle.';
            $_lang_user['pacc_ordertext'] =
                'Neben unserem kostenlosen Angebot bieten wir auch Pakete mit mehr Funktionen und Leistungen an. Im Folgenden finden Sie einen &Uuml;berblick &uuml;ber verf&uuml;gbare Pakete und deren Preise.<br />Sie k&ouml;nnen ein Paket auf Wunsch direkt hier bestellen. Selbstverst&auml;ndlich k&ouml;nnen Sie auch zuerst unser kostenloses Angebot nutzen und auf Wunsch sp&auml;ter ein Paket mit zus&auml;tzlichen Leistungen erwerben.';
            ...
            $_lang_user['prefs_d_pacc_mod'] =
                'Verbessern Sie die Leistung Ihres Accounts und verwalten Sie Ihre Account-Upgrades.';
            ...
            $_lang_user['pacc_noactivesubscription'] =
                'Im Moment ist kein Abonnement aktiv.';
            ...
            $_lang_user['pacc_norecentorders'] =
                'Es wurden keine Bestellungen in Ihrem Account gefunden.';
            ...
            $_lang_user['pacc_otherpackwarning'] =
                'Es besteht derzeit noch ein aktives Abonnement f&uuml;r ein anderes Paket. Wenn Sie die Bestellung durchf&uuml;hren und abschlie&szlig;en, erlischt Ihr aktuelles Abonnement.';
            $_lang_user['pacc_finalamount'] = 'End-Betrag';
            $_lang_user['pacc_unlimited'] = 'unbegrenzt';
            $_lang_user['pacc_runtimenote'] =
                'Die Laufzeit muss ein ganzzahliges Vielfaches von %d sein (%d, %d, %d, ...).';
            ...
            $_lang_user['pacc_placeorder'] =
                'Bestellung zahlungspflichtig abschicken';
            $_lang_user['pacc_placeorderfree'] = 'Kostenlos bestellen';
            $_lang_user['pacc_accunit'] = 'Abrechnungseinheit';
            $_lang_user['pacc_pn_paypal'] =
                'Den Rechnungsbetrag (%.02f %s) haben wir dankend per PayPal erhalten.';
            $_lang_user['pacc_pn_banktransfer'] =
            ...
            $_lang_user['pacc_pn_sofortueberweisung'] =
                'Den Rechnungsbetrag (%.02f %s) haben wir dankend per sofortueberweisung.de erhalten.';
            $_lang_user['pacc_thanks'] = 'Vielen Dank f&uuml;r Ihr Bestellung.';
            $_lang_user['pacc_thanks_paypal'] =
                'Bitte klicken Sie nun auf den folgenden Button, um zur PayPal-Zahlungsseite zu gelangen, falls Sie nicht automatisch weitergeleitet werden. Nach abgeschlossener Zahlung wird Ihre Bestellung umgehend freigeschaltet.';
            $_lang_user['pacc_thanks_banktransfer'] =
                'Bitte &uuml;berweisen Sie nun den f&auml;lligen Rechnungsbetrag (<b>%.02f %s</b>) auf unser nachfolgendes Bankkonto. Achten Sie dabei <i>unbedingt</i> auf die Verwendung des angegebenen Verwendungszwecks!';
            $_lang_user['pacc_thanks_banktransfer2'] =
                'Sobald der Betrag auf unserem Konto eingegangen ist, wird Ihre Bestellung freigeschaltet.';
            $_lang_user['pacc_thanks_sofortueberweisung'] =
                'Bitte klicken Sie nun auf den folgenden Button, um zur Zahlungsseite von sofortueberweisung.de zu gelangen, falls Sie nicht automatisch weitergeleitet werden. Nach abgeschlossener Zahlung wird Ihre Bestellung umgehend freigeschaltet.';
            ...
            $_lang_user['pacc_paymentreturn'] =
                'Vielen Dank f&uuml;r Ihre Bestellung und das Ausf&uuml;hren der Zahlung. Sofern die Zahlung erfolgreich war, wird diese umgehend freigeschaltet. Sie k&ouml;nnen den Status jederzeit unter &quot;Account-Upgrade&quot; im Bereich &quot;Einstellungen&quot; einsehen.';
            $_lang_user['pacc_paymentreturn2'] =
                'Vielen Dank f&uuml;r Ihre Bestellung und das Ausf&uuml;hren der Zahlung. Sofern die Zahlung erfolgreich war, wird diese umgehend freigeschaltet. Sobald Ihr Account freigeschaltet ist, k&ouml;nnen Sie sich auf der <a href="index.php">Startseite</a> einloggen - probieren Sie es doch einfach schon einmal!';
            $_lang_user['pacc_paymentreturn3'] =
                'Vielen Dank f&uuml;r Ihre Anmeldung f&uuml;r eines unserer kostenlosen Pakete. Sie k&ouml;nnen sich nun auf unserer <a href="index.php">Startseite</a> einloggen.';
            ...
            $_lang_user['pacc_dearsirormadam'] =
                'Sehr geehrte Damen und Herren';
            $_lang_user['pacc_invtext'] =
            ...
            $_lang_user['pacc_kindregards'] =
                'Mit freundlichen Gr&uuml;&szlig;en';
            $_lang_user['pacc_bankacc'] = 'Bankverbindung';
            $_lang_user['pacc_invfooter'] =
                'Diese Rechnung wurde maschinell erstellt und ist auch ohne Unterschrift g&uuml;ltig.';
            $_lang_user['pacc_activated'] =
                'Ihre Bestellung wurde freigeschaltet.';
            $_lang_user['pacc_next'] = 'Weiter';
            $_lang_user['pacc_cancelwarning'] =
                'Wenn Sie Ihre Mitgliedschaft k&uuml;ndigen, gehen auch Ihr aktuelles Account-Upgrade-Abonnement sowie Ihr gesamtes Credit-Guthaben unwiderruflich verloren. Hier finden Sie noch einemal Infos zu Ihrem aktuellen Abonnement. Klicken Sie auf &quot;Weiter &gt;&gt;&quot;, wenn Sie einverstanden sind, dass Ihr Abonnement und Ihr Guthaben verloren gehen.';
            $_lang_user['pacc_maxerror'] =
                'Dieses Paket ist f&uuml;r maximal <b>%d %s</b> buchbar. Nat&uuml;rlich k&ouml;nnen Sie Ihre Buchung sp&auml;ter vor Ablauf verl&auml;ngern, jedoch darf die Laufzeit die angegebene maximale Laufzeit nicht &uuml;berschreiten.';
            $_lang_user['pacc_packages'] = 'Pakete';
            $_lang_user['pacc_signuptext'] =
                'F&uuml;llen Sie einfach das folgende Formular aus, um das gew&auml;hlte Paket zu bestellen.';
            ...
            $_lang_admin['pacc_deletepackagedesc'] =
                'Zu diesem Paket existieren ein oder mehrere Abonnements. Was soll mit diesen Abonnements geschehen?';
            $_lang_admin['pacc_delcontinue'] =
                'Zum Laufzeitende auslaufen lassen';
            ...
            $_lang_admin['pacc_realcancel'] =
                'Wollen Sie das Abonnement wirklich beenden?';
            $_lang_admin['pacc_locked_at_signup'] =
                '[%s] Dieser Benutzer wurde nach seiner Anmeldung durch das PremiumAccount-Modul gesperrt und wird nach erfolgter Bestellung eines Pakets automatisch aktiviert.';
            $_lang_admin['pacc_moved_note'] =
                '[%s] Dieser Benutzer wurde durch das PremiumAccount-Modul in die Gruppe <%d> verschoben und aktiviert, nachdem die Bestellung <%d> bestaetigt wurde.';
            $_lang_admin['pacc_expire_moved_note'] =
                '[%s] Dieser Benutzer wurde durch das PremiumAccount-Modul in die Gruppe <%d> verschoben, nachdem das Abonnement <%d> abgelaufen ist.';
            $_lang_admin['pacc_expire_notmoved_note'] =
                '[%s] Dieser Benutzer wurde durch das PremiumAccount-Modul NICHT in die Gruppe <%d> verschoben, nachdem das Abonnement <%d> abgelaufen ist, da er manuell in eine nicht dem Paket zugehoerige Gruppe verschoben wurde.';
            $_lang_admin['pacc_expire_locked_note'] =
                '[%s] Dieser Benutzer wurde durch das PremiumAccount-Modul gesperrt, nachdem das Abonnement <%d> abgelaufen ist.';
            $_lang_admin['pacc_afterdays'] = 'Tagen';
            $_lang_admin['pacc_after'] = 'nach';
            $_lang_admin['pacc_delete_order'] =
                'Offene Bestellungen l&ouml;schen';
            $_lang_admin['pacc_pay_notification'] =
                'Benachrichtigung bei Zahlung';
            $_lang_admin['pacc_update_notification'] =
                'Abo-Ablauf-Benachrichtigung';
            ...
            $_lang_admin['pacc_su_createnew'] =
                'Projekt bei sofortueberweisung.de anlegen';
            $_lang_admin['pacc_signup_order'] =
                'Bestell-Seite nach Registrierung';
            $_lang_admin['pacc_signup_order_force'] =
                'Bestellung obligatorisch';
            ...
            $_lang_admin['pacc_sucurrencyerror'] =
                'Die Zahlung per sofortueberweisung.de erfordert, dass die Zahlungs-W&auml;hrung EUR oder CHF ist!';
            $_lang_admin['text_pacc_pn_subject'] =
                'PremiumAccount: Zahlungs-Nachricht-Betreff';
            $_lang_admin['text_pacc_pn_text'] =
                'PremiumAccount: Zahlungs-Nachricht-Text';
            $_lang_admin['text_pacc_nm_subject'] =
                'PremiumAccount: Ablauf-Hinweis-Betreff';
            $_lang_admin['text_pacc_nm_text'] =
                'PremiumAccount: Ablauf-Hinweis-Text';
            $_lang_admin['pacc_extendsubscrdesc'] =
                'Gew&auml;hlte(s) Abonnement(s) verl&auml;ngern...';
            ...
            $_lang_admin['pacc_act_notfound'] =
                'Die angegebene Bestellung wurde nicht gefunden oder ist bereits abgeschlossen.';
            $_lang_admin['pacc_act_success'] =
                'Die Zahlung wurde erfolgreich freigeschaltet!';
            $_lang_admin['pacc_act_error'] =
                'Die Zahlung konnte nicht freigeschaltet werden. M&ouml;glicherweise ist der angegebene Betrag zu gering.';
            ...
            $_lang_admin['pacc_update_notification_altmail'] =
                'Auch an Alternativ-E-Mail-Adresse senden';
            ...
            // custom
            $_lang_custom['pacc_nm_subject'] =
                'Your subscription expires within a short time';
            $_lang_custom['pacc_nm_text'] =
                'Dear Sir or Madam,' .
                "\n\n" .
            ...
            $_lang_user['pacc_signup_aborted'] =
                'The sign up process has been aborted and your user data has been discarded. Thank you for your interest in our services.<br />You are welcome to sign up again anytime. If you encounter questions, please do not hesitate to contact us.';
            $_lang_user['pacc_locktext'] =
                'Your account is not active anymore. You can re-activate your account by renewing your account subscription. We invite you to choose betweem the following offers. You can find detailed information below.';
            $_lang_user['pacc_forcetext'] =
                'Please choose the offer you would like to subscribe to. You can find detailed information in the table below.';
            $_lang_user['pacc_ordertext'] =
                'Besides our free services, we also offer subscriptions with enhanced services and features. You can find detailed information and prices below.<br />You can subscribe to an offer just here, if you like to. Of course you can use our free service first and subscribe later, if you are satisfied.';
            ...
            $_lang_user['pacc_mod'] = 'Account Upgrade';
            $_lang_user['prefs_d_pacc_mod'] =
                'Enhance the features of your account and manage your active subscriptions.';
            $_lang_user['pacc_prefs_intro'] =
                'You can enhance the features and services of your account by ordering a subscription. You can find your active subscription and the expiration date below.';
            ...
            $_lang_user['pacc_otherpackwarning'] =
                'You still have an active subscription for another package. Your old subscription will be cancelled, if you complete this order.';
            $_lang_user['pacc_finalamount'] = 'Final amount';
            $_lang_user['pacc_unlimited'] = 'unlimited';
            $_lang_user['pacc_runtimenote'] =
                'The runtime must be a multiple of %d (%d, %d, %d, ...).';
            ...
            $_lang_user['pacc_pn_paypal'] =
                'The invoiced amount (%.02f %s) has been paid using PayPal.';
            $_lang_user['pacc_pn_banktransfer'] =
                'Please transfer the invoiced amount (%.02f %s) to our bank account stated below. <b>Necessarily</a> use the following code as the payment subject: <b>VK-%s</b>.<br />Your subscription will be activated as soon as the payment is visible in our bank account.';
            $_lang_user['pacc_pn_sofortueberweisung'] =
                'The invoided amount (%.02f %s) has been paid using sofortueberweisung.de.';
            $_lang_user['pacc_thanks'] = 'Thank you for your order.';
            $_lang_user['pacc_thanks_paypal'] =
                'Please click at the following button to visit the PayPal payment page if you are not redirected automaticaly. After completing the payment, your subscription will be activated.';
            $_lang_user['pacc_thanks_banktransfer'] =
                'Please transfer the invoiced amount (<b>%.02f %s</b>) to our bank account stated below. <i>Necessarily</i> use the stated payment subject!';
            $_lang_user['pacc_thanks_banktransfer2'] =
                'As soon as the payment is visible in our bank account your subscription will be activated.';
            $_lang_user['pacc_thanks_sofortueberweisung'] =
                'Please click at the following button to visit the sofortueberweisung.de z payment page if you are not redirected automaticaly. After completing the payment, your subscription will be activated.';
            ...
            $_lang_user['pacc_paymentreturn'] =
                'Thank you for your order. If your payment has been successful, your subscription will be unlocked immediately. You can view the order status at the &quot;Account Upgrade&quot; page in the &quot;Preferences&quot; section.';
            $_lang_user['pacc_paymentreturn2'] =
                'Thank you for your order. If your payment has been successful, your subscription will be unlocked immediately. As soon as your account is activated, you can log in at the <a href="index.php">start page</a> - just try it now!';
            $_lang_user['pacc_paymentreturn3'] =
                'Thank you for chosing one of our free plans. You can now log in to you account on our <a href="index.php">start page</a>!';
            ...
            $_lang_user['pacc_invfooter'] =
                'This invoice has been generated automaticaly and is valid without a signature.';
            $_lang_user['pacc_activated'] = 'Your order has been activated.';
            $_lang_user['pacc_next'] = 'Next';
            $_lang_user['pacc_cancelwarning'] =
                'When you cancel your accont, your account subscription and all your credits will be lost. You can find your current subscription below. Click at &quot;Next &gt;&gt;&quot; in case you accept that your subscription and your credits will be void.';
            $_lang_user['pacc_maxerror'] =
                'This package can be booked for a maximum time frame of <b>%d %s</b>. Of course you can renew/extend your subscription when it expires.';
            $_lang_user['pacc_packages'] = 'Packages';
            $_lang_user['pacc_signuptext'] =
                'Please fill in the following form to order the selected package.';
            ...
            $_lang_admin['pacc_deletepackagedesc'] =
                'One or more users subscribe to this package. What shall be done with the active subscriptions?';
            $_lang_admin['pacc_delcontinue'] =
                'Continue subscriptions until they expire';
            ...
            $_lang_admin['pacc_locked_at_signup'] =
                '[%s] This user has been locked by the PremiumAccount plugin after signing up and will be activated as soon as he completes an order.';
            $_lang_admin['pacc_moved_note'] =
                '[%s] This user has been activated and moved to the group <%d> by the PremiumAccount plugin after the order <%d> has been activated.';
            $_lang_admin['pacc_expire_moved_note'] =
                '[%s] This user has been moved to the group <%d> by the PremiumAccount plugin after the subscription <%d> has expired.';
            $_lang_admin['pacc_expire_notmoved_note'] =
                '[%s] This user has NOT been moved to the group <%d> by the PremiumAccount plugin after the subscription <%d> has expired because he was manually moved to a group not belonging to this package.';
            $_lang_admin['pacc_expire_locked_note'] =
                '[%s] This user has been locked by the PremiumAccount plugin after the subscription <%d> has expired.';
            ...
            $_lang_admin['pacc_su_createnew'] =
                'Create sofortueberweisung.de-project';
            ...
            $_lang_admin['pacc_sucurrencyerror'] =
                'The sofortueberweisung.de payment method required EUR or CHF as currency!';
            $_lang_admin['text_pacc_pn_subject'] =
                'PremiumAccount: Payment notification subject';
            $_lang_admin['text_pacc_pn_text'] =
                'PremiumAccount: Payment notification text';
            $_lang_admin['text_pacc_nm_subject'] =
                'PremiumAccount: Expiration notification subject';
            $_lang_admin['text_pacc_nm_text'] =
                'PremiumAccount: Expiration notification text';
            ...
            $_lang_admin['pacc_act_notfound'] =
                'The order cannot be found or is already completed.';
            $_lang_admin['pacc_act_success'] =
                'The payment has been activated successfuly!';
            $_lang_admin['pacc_act_error'] =
                'The payment cannot be unlocked. Probably the payment amount is too low.';
            ...
            $_lang_admin['pacc_update_notification_altmail'] =
                'Also send to alternative email address';
            $_lang_admin['pacc_fieldpos'] = 'Position';
        ...
        $arrays = ['admin', 'client', 'user', 'custom'];
        foreach ($arrays as $array) {
            ...
            foreach ($$srcArray as $key => $val) {
                if (
                    function_exists('CharsetDecode') &&
                    !in_array(strtolower($currentCharset), [
                        'iso-8859-1',
                        'iso-8859-15',
                    ])
                ) {
    ...
    function Install() {
        ...
        // db struct
        $databaseStructure =
            // checksum: 4eab06ece647cda6068ee3a4f678eaff
        ...
        if ($rowCount < 1) {
            // insert prefs row
            $db->Query(
                'INSERT INTO {pre}mod_premium_prefs(`fields`) VALUES(?)',
            ...
            while ($row = $res->FetchArray(MYSQLI_ASSOC)) {
                ...
                $fields = array_diff($fields, ['httpmail']);
                $db->Query(
                    'UPDATE {pre}mod_premium_prefs SET `fields`=?',
                    serialize($fields),
                );
            }
            $res->Free();
        ...
        // log
        PutLog(
            sprintf('%s v%s installed', $this->name, $this->version),
            PRIO_PLUGIN,
            __FILE__,
            __LINE__,
        );
    ...
    function AdminHandler() {
        ...
        if ($_REQUEST['action'] == 'overview') {
            $this->_overviewPage();
        } elseif ($_REQUEST['action'] == 'packages') {
            $this->_packagesPage();
        } elseif ($_REQUEST['action'] == 'subscriptions') {
    ...
    function OnCron() {
        ...
        $db->Query(
            'DELETE FROM {pre}mod_premium_userauth WHERE date<?',
            time() - TIME_ONE_DAY,
        );
        ...
        if ($this->prefs['delete_order'] == 'yes') {
            $res = $db->Query(
                'SELECT `orderid` FROM {pre}orders WHERE `status`=0 AND `created`<' .
                    (time() - $this->prefs['delete_order_after']),
            );
            while ($row = $res->FetchArray(MYSQLI_ASSOC)) {
                $db->Query(
        ...
        if ($this->prefs['send_update_notification'] == 'yes') {
            $expireTimeframe =
                $this->prefs['update_notification_days'] * TIME_ONE_DAY;
            $expireDate = time() + $expireTimeframe;
            $sentIDs = [];

            // search for subscriptions
            $res = $db->Query(
                'SELECT id,benutzer,paket FROM {pre}mod_premium_subscribers WHERE ablauf<' .
                    $expireDate .
                    ' AND last_update_notification<(ablauf-' .
                    $expireTimeframe .
                    ') AND ablauf>1',
            );
            while ($row = $res->FetchArray(MYSQLI_ASSOC)) {
                // get user details
                $userRes = $db->Query(
                    'SELECT email,vorname,nachname,altmail,`language` FROM {pre}users WHERE id=? AND gesperrt=\'no\'',
                    $row['benutzer'],
                );
                ...
                // get package details
                $packageRes = $db->Query(
                    'SELECT titel,preis_cent,abrechnung,abrechnung_t,`alt_titles` FROM {pre}mod_premium_packages WHERE id=?',
                    $row['paket'],
                );
                ...
                $vars = [
                    ...
                    'betrag' => sprintf(
                        '%.02f %s',
                        $this->_calcOrderAmount(
                            $row['paket'],
                            $package['abrechnung_t'],
                        ) / 100,
                        $bm_prefs['currency'],
                    ),
                    'zeit' => $this->_intervalStr(
                        $package['abrechnung'],
                        $package['abrechnung_t'],
                        true,
                    ),
                ...
                if (
                    SystemMail(
                        sprintf(
                            '"%s" <%s>',
                            $bm_prefs['pay_emailfrom'],
                            $bm_prefs['pay_emailfromemail'],
                        ),
                        $userRow['email'],
                        GetPhraseForUser(
                            $row['benutzer'],
                ...
                if (
                    !empty($userRow['altmail']) &&
                    $this->prefs['update_notification_altmail'] == 'yes'
                ) {
                    SystemMail(
                        sprintf(
                            '"%s" <%s>',
            ...
            if (count($sentIDs) > 0) {
                $db->Query(
                    'UPDATE {pre}mod_premium_subscribers SET last_update_notification=? WHERE id IN ?',
                    time(),
                    $sentIDs,
                );
            }
        ...
        $deleteSubscriptions = [];
        $res = $db->Query(
            'SELECT id,benutzer,paket FROM {pre}mod_premium_subscribers WHERE ablauf>1 AND ablauf<' .
                time(),
        );
        while ($row = $res->FetchArray(MYSQLI_ASSOC)) {
            // get package details
            $packageRes = $db->Query(
                'SELECT fallback_grp,`gruppe` FROM {pre}mod_premium_packages WHERE id=?',
                $row['paket'],
            );
            $package = $packageRes->FetchArray(MYSQLI_ASSOC);
            $packageRes->Free();
            ...
            $userGroup = -1;
            $userRes = $db->Query(
                'SELECT `gruppe` FROM {pre}users WHERE `id`=?',
                $row['benutzer'],
            );
            if ($userRes->RowCount() == 1) {
                $userRow = $userRes->FetchArray(MYSQLI_ASSOC);
            ...
            if ($package['fallback_grp'] == -1) {
                $db->Query(
                    'UPDATE {pre}users SET gesperrt=?,notes=CONCAT(notes,?) WHERE id=?',
                    'locked',
                    sprintf(
                        $lang_admin['pacc_expire_locked_note'],
                        date('r'),
                        $row['id'],
                    ),
                    $row['benutzer'],
                );
            } elseif ($userGroup == -1 || $userGroup == $package['gruppe']) {
                $db->Query(
                    'UPDATE {pre}users SET gruppe=?,notes=CONCAT(notes,?) WHERE id=?',
                    $package['fallback_grp'],
                    sprintf(
                        $lang_admin['pacc_expire_moved_note'],
                        date('r'),
                        $package['fallback_grp'],
                        $row['id'],
                    ),
                ...
                $db->Query(
                    'UPDATE {pre}users SET notes=CONCAT(notes,?) WHERE id=?',
                    sprintf(
                        $lang_admin['pacc_expire_notmoved_note'],
                        date('r'),
                        $package['fallback_grp'],
                        $row['id'],
                    ),
            ...
            PutLog(
                sprintf(
                    'PremiumAccount: Subscription #%d of user #%d has expired',
                    $row['id'],
                    $row['benutzer'],
                ),
                PRIO_NOTE,
        ...
        if (count($deleteSubscriptions) > 0) {
            $db->Query(
                'DELETE FROM {pre}mod_premium_subscribers WHERE id IN ?',
                $deleteSubscriptions,
            );
        }
        ...
        $deletePackages = [];
        $res = $db->Query(
            'SELECT id FROM {pre}mod_premium_packages WHERE geloescht=1',
        );
        while ($row = $res->FetchArray(MYSQLI_ASSOC)) {
            $subRes = $db->Query(
                'SELECT COUNT(*) FROM {pre}mod_premium_subscribers WHERE paket=?',
                $row['id'],
            );
        ...
        if (count($deletePackages) > 0) {
            $db->Query(
                'DELETE FROM {pre}mod_premium_packages WHERE id IN ?',
                $deletePackages,
            );
        }
    }
    ...
    function BeforePageTabsAssign(&$tabs) {
        ...
        if (
            count(
                $subscriptions = $this->_getUserSubscriptions($userRow['id']),
            ) > 0
        ) {
            ...
            if ($activeSubscription['package']['template'] != '') {
                ...
                if (file_exists(B1GMAIL_DIR . 'templates/' . $template . '/')) {
                    $tpl->template_dir =
                        B1GMAIL_DIR . 'templates/' . $template . '/';
                    $tpl->compile_dir =
                        B1GMAIL_DIR . 'templates/' . $template . '/cache/';
                    $tpl->assign(
                        'tpldir',
                        B1GMAIL_REL . 'templates/' . $template . '/',
                    );
    ...
    function getUserPages($loggedin) {
        ...
        if (
            $loggedin ||
            $this->prefs['nli_packages_page'] != 'yes' ||
            !$this->_packagesAvailable()
        ) {
            return [];
        }
    ...
    function _paccNLIPackages($signupMode = false) {
        ...
        if (
            $this->prefs['nli_packages_page'] == 'no' ||
            !$this->_packagesAvailable()
        ) {
            return;
        }
        ...
        $b1gMail74orLater =
            $versionComponents[0] > 7 ||
            ($versionComponents[0] == 7 && $versionComponents[1] >= 4);

        $tpl->register_function('paccFormatField', [
            &$this,
            '_smartyPaccFormatField',
        ]);
        $tpl->assign('signUp', $signupMode);
        $tpl->assign('nliPackages', true);
        $tpl->assign(
            'regEnabled',
            $bm_prefs['regenabled'] == 'yes' && $b1gMail74orLater,
        );
        $tpl->assign('page', $this->_templatePath('pacc.nli.packages.tpl'));
        $tpl->assign('matrix', $this->_packageMatrix($vatRate));
        $tpl->assign(
            'pageTitle',
            $signupMode ? $lang_user['signup'] : $lang_user['pacc_packages'],
        );
    ...
    function _getPackage($packageID) {
        ...
        $res = $db->Query(
            'SELECT id,titel,beschreibung,abrechnung,abrechnung_t,preis_cent,laufzeiten,max_laufzeit,`alt_titles`,`alt_descriptions` FROM {pre}mod_premium_packages WHERE id=? AND geloescht=0',
            $packageID,
        );
        if ($res->RowCount() == 1) {
            ...
            $package = [
                'id' => $row['id'],
                'title' => $this->_getTranslatedText(
                    $row['titel'],
                    $row['alt_titles'],
                ),
                'description' => $this->_getTranslatedText(
                    $row['beschreibung'],
                    $row['alt_descriptions'],
                ),
                'price' => $price,
                'priceTax' => $this->_taxStr($vatRate),
                'priceInterval' => $this->_intervalStr(
                    $row['abrechnung'],
                    $row['abrechnung_t'],
                ),
    ...
    function FileHandler($file, $action) {
        ...
        if ($file == 'index.php' && $action == 'signup') {
            if (
                isset($_REQUEST['paccPackage']) &&
                ($package = $this->_getPackage($_REQUEST['paccPackage'])) !==
                    false
            ) {
                $tpl->registerHook(
                    'nli:signup.tpl:panelGroupStart',
            ...
            } elseif ($this->prefs['nli_packages_page'] == 'replace') {
        ...
        if ($file == 'index.php' && $action == 'paccPaymentReturn') {
            ...
            $file == 'index.php' &&
            $action == 'paccPackageDetails' &&
            isset($_REQUEST['id'])
        ) {
            $this->_showPackageDetails($_REQUEST['id']);
            exit();
        } elseif ($file == 'index.php' && $action == 'paccPackages') {
            ...
            if ($action == 'paccPackageDetails' && isset($_REQUEST['id'])) {
                $this->_showPackageDetails($_REQUEST['id']);
                exit();
            }
            ...
            if (
                ...
                $GLOBALS['prefsImages']['pacc_mod'] =
                    'plugins/templates/images/pacc_subscriptions_user.png';
                $GLOBALS['prefsIcons']['pacc_mod'] =
                    'plugins/templates/images/pacc_subscriptions_user.png';
            }
            ...
            if (
                ...
                if (
                    count(
                        $subscriptions = $this->_getUserSubscriptions(
                            $userRow['id'],
                        ),
                    ) > 0
                ) {
    ...
    function UserPrefsPageHandler($action) {
        ...
        if (!isset($_REQUEST['do'])) {
            ...
            $tpl->assign(
                'poHeight',
                150 + 25 * count(unserialize($this->prefs['fields'])),
            );
            $tpl->assign(
                'matrix',
                $this->_packageMatrix($this->_vatRateForUser($userRow['id'])),
            );
            $tpl->assign(
                'pageContent',
                $this->_templatePath('pacc.user.overview.tpl'),
            );
            $tpl->display('li/index.tpl');
        }

        // cancel account warning
        elseif ($_REQUEST['do'] == 'cancelAccountWarning') {
            if (
                count(
                    $subscriptions = $this->_getUserSubscriptions(
                        $userRow['id'],
            ...
            $tpl->assign(
                'pageContent',
                $this->_templatePath('pacc.user.cancelwarning.tpl'),
            );
            $tpl->display('li/index.tpl');
        }

        // order page
        elseif ($_REQUEST['do'] == 'order' && isset($_REQUEST['id'])) {
            $this->_prepareOrderPage(
                $userRow['id'],
                (int) $_REQUEST['id'],
                $userRow,
            );
            $tpl->assign(
                'pageContent',
                $this->_templatePath('pacc.user.order.tpl'),
            );
            $tpl->display('li/index.tpl');
        }

        // place order
        elseif ($_REQUEST['do'] == 'placeOrder' && isset($_REQUEST['id'])) {
            $packageID = (int) $_REQUEST['id'];

            if (
                !$this->_initiateOrderPlacement(
                    $userRow['id'],
                    $packageID,
                    $userRow,
                )
        ...
        if (
            ...
            if (isset($_REQUEST['paccPackage'])) {
                ...
                if ($this->_getPackage($packageID) !== false) {
                    $db->Query(
                        'REPLACE INTO {pre}mod_premium_userauth(`userid`,`token`,`date`) VALUES(?,?,?)',
                        $userID,
    ...
    function OnLoginFailed($userMail, $password, $reason) {
        if (
            $this->prefs['signup_order_force'] == 'yes' &&
            $this->prefs['signup_order_page'] == 'yes' &&
            $reason == BM_LOCKED
        ) {
            $user = _new('BMUser', [BMUser::GetID($userMail, true)]);
    ...
    function _fieldTitle($name) {
        ...
        if (isset($aliases[$name])) {
            $name = $aliases[$name];
        } elseif (isset($groupOptions[$name])) {
            ...
            switch ($abrechnung) {
                case 'wochen':
                    return ($withoutPrefix
                        ? '1 '
                        : $lang_user['pacc_jede'] . ' ') .
                        $lang_user['pacc_woche'];
                    break;
                case 'monate':
                    return ($withoutPrefix
                        ? '1 '
                        : $lang_user['pacc_jeden'] . ' ') .
                        $lang_user['pacc_monat'];
                    break;
                case 'jahre':
                    return ($withoutPrefix
                        ? '1 '
                        : $lang_user['pacc_jedes'] . ' ') .
                        $lang_user['pacc_jahr'];
                    break;
                case 'einmalig':
    ...
    function _packageMatrix($vatRate, $id = 0) {
        ...
        // get packages
        $res = $db->Query(
            'SELECT id,titel,abrechnung,abrechnung_t,preis_cent,beschreibung,gruppe,accentuation,`alt_titles`,`alt_descriptions` FROM {pre}mod_premium_packages WHERE geloescht=0 ' .
                ($id != 0 ? 'AND id=' . (int) $id . ' ' : '') .
                'ORDER BY `order` ASC,preis_cent ASC',
        );
        while ($row = $res->FetchArray(MYSQLI_ASSOC)) {
            // get fields
            $fields = [];
            ...
            while ($groupRow = $groupRes->FetchArray(MYSQLI_ASSOC)) {
                ...
                if (
                    ...
                    $groupRow['send_limit_time'] % 60 == 0
                ) {
                    $timeUnit = $lang_user['pacc_hours'];
                    $groupRow['send_limit_time'] /= 60;
                }
                $groupRow['send_limit'] = sprintf(
                    $lang_user['pacc_sendlimit'],
    ...
    function _showPackageDetails($id) {
        ...
        $res = $db->Query(
            'SELECT id,titel,beschreibung,geloescht,`alt_titles`,`alt_descriptions` FROM {pre}mod_premium_packages WHERE id=? AND geloescht=0',
            $id,
        );
        if ($res->RowCount() == 1) {
            $row = $res->FetchArray(MYSQLI_ASSOC);
            ...
            $row['titel'] = $this->_getTranslatedText(
                $row['titel'],
                $row['alt_titles'],
            );
            $row['beschreibung'] = $this->_getTranslatedText(
                $row['beschreibung'],
                $row['alt_descriptions'],
            );
    ...
    function _activateOrder($packageID, $count, $orderID, $userID) {
        ...
        // fetch package
        $res = $db->Query(
            'SELECT gruppe,abrechnung,abrechnung_t FROM {pre}mod_premium_packages WHERE id=?',
            $packageID,
        );
        if ($res->RowCount() == 0) {
            PutLog(
                sprintf(
                    'PremiumAccount: ActivateOrderItem(%d, %d): Associated package not found',
                    $orderID,
                    $userID,
                ),
                PRIO_WARNING,
        ...
        if ($package['abrechnung'] != 'einmalig') {
            $intervals = [
                'wochen' => TIME_ONE_WEEK,
                'monate' => TIME_ONE_MONTH,
                'jahre' => TIME_ONE_YEAR,
            ];
            $expire =
                time() +
                $count *
                    $package['abrechnung_t'] *
                    $intervals[$package['abrechnung']];
        }

        // active subscription?
        $deleteSubscriptions = [];
        $res = $db->Query(
            'SELECT id,paket,ablauf FROM {pre}mod_premium_subscribers WHERE benutzer=?',
            $userID,
        );
        while ($subscription = $res->FetchArray(MYSQLI_ASSOC)) {
            if ($subscription['paket'] == $packageID && $expire != -1) {
        ...
        if (count($deleteSubscriptions) > 0) {
            $db->Query(
                'DELETE FROM {pre}mod_premium_subscribers WHERE id IN(?) AND benutzer=?',
                $deleteSubscriptions,
                $userID,
            );
        }
        ...
        // create subscription
        $db->Query(
            'INSERT INTO {pre}mod_premium_subscribers(benutzer,paket,letzte_zahlung,ablauf,last_update_notification) ' .
                'VALUES(?,?,?,?,?)',
            $userID,
            $packageID,
            time(),
        ...
        $db->Query(
            'UPDATE {pre}users SET gruppe=?,notes=CONCAT(notes,?),gesperrt=? WHERE id=?',
            $package['gruppe'],
            sprintf(
                $lang_admin['pacc_moved_note'],
                date('r'),
                $package['gruppe'],
                $orderID,
            ) . "\n",
        ...
        if ($orderID == -1) {
            PutLog(
                'PremiumAccount: Order of free package activated successfuly',
                PRIO_NOTE,
                __FILE__,
                __LINE__,
            );
            ...
            PutLog(
                sprintf(
                    'PremiumAccount: Order #%d activated successfuly',
                    $orderID,
                ),
                PRIO_NOTE,
                __FILE__,
    ...
    function ActivateOrderItem($orderID, $userID, $cartItem) {
        ...
        [, , $packageID] = explode('.', $cartItem['key']);
    ...
    function _prepareOrderPage($userID, $packageID, $userRow, $nli = false) {
        ...
        if ($res->RowCount() == 1) {
            ...
            $package['titel'] = $this->_getTranslatedText(
                $package['titel'],
                $package['alt_titles'],
            );
            $package['beschreibung'] = $this->_getTranslatedText(
                $package['beschreibung'],
                $package['alt_descriptions'],
            );
        ...
        if ($package['isFree'] && $nli) {
            if ($this->_activateOrder($package['id'], 1, -1, $userID)) {
                // delete auth row
                $db->Query(
                    'DELETE FROM {pre}mod_premium_userauth WHERE userid=?',
                    $userID,
                );
        ...
        $tpl->assign(
            'packageAmount',
            sprintf('%.02f', $package['preis_cent'] / 100),
        );
        $tpl->assign(
            'runtimeNote',
            sprintf(
                $lang_user['pacc_runtimenote'],
                $package['abrechnung_t'],
                $package['abrechnung_t'],
                $package['abrechnung_t'] * 2,
                $package['abrechnung_t'] * 3,
            ),
        );
        $tpl->assign(
            'taxNote',
            sprintf(
                $lang_user['pacc_taxnote'],
                $this->_vatRateForUser($userID),
            ),
        );
        ...
        if ($package['abrechnung'] != 'einmalig') {
            $tpl->assign(
                'intervalStr',
                $lang_user['pacc_' . $package['abrechnung'] . '2'],
            );
        }
     ...
     * @return bool
     */
    function _initiateOrderPlacement(
        $userID,
        $packageID,
        $userRow,
        $nli = false
        ...
        if ($package['abrechnung'] == 'einmalig') {
            ...
            if (
                ...
                ($package['laufzeiten'] != '*' &&
                    !in_array(
                        $abrechnung_t,
                        explode(',', $package['laufzeiten']),
                    ))
            ) {
                $invalidFields[] = 'abrechnung_t';
            } else {
                $amount =
                    ($abrechnung_t / $package['abrechnung_t']) *
                    $package['preis_cent'];
            }
        }
        ...
        if ($package['max_laufzeit'] != 0) {
            ...
            if ($package['abrechnung'] != 'einmalig') {
                ...
                $expire =
                    time() + $abrechnung_t * $intervals[$package['abrechnung']];
                $maxExpire =
                    time() +
            ...
            if ($expire != -1 && $maxExpire != -1 && $expire > $maxExpire) {
                ...
                $tpl->assign(
                    'errorMsg',
                    sprintf(
                        $lang_user['pacc_maxerror'],
                        $package['max_laufzeit'],
                        $lang_user[
                            'pacc_' .
                                $package['abrechnung'] .
                                ($package['max_laufzeit'] > 1 ? '2' : '')
                        ],
                    ),
                );
            }
        ...
        if (
            ...
            (!$package['isFree'] &&
                ($orderID = BMPayment::ProcessPaymentForm(
                    $tpl,
                    $cart,
                    false,
                    $userID,
            ...
            $tpl->assign(
                'taxNote',
                sprintf($lang_user['pacc_taxnote'], $bm_prefs['steuersatz']),
            );
            $tpl->assign('package', $package);
        ...
        elseif (isset($amount)) {
            if ($amount == 0 && $orderID == -1) {
                if ($this->_activateOrder($package['id'], 1, -1, $userID)) {
                    ...
                    $tpl->assign(
                        'backLink',
                        'prefs.php?action=pacc_mod&sid=' . session_id(),
                    );
                } else {
                    die('Failed to activate order');
                }
            } else {
                BMPayment::InitiatePayment(
                    $tpl,
                    $orderID,
                    $nli
                        ? $bm_prefs['selfurl'] .
                            'index.php?action=paccPaymentReturn'
                        : '',
                    'pageContent',
                    $userID,
                );
    ...
    function _calcOrderAmount($packageID, $abrechnungT = -1) {
        ...
        $res = $db->Query(
            'SELECT abrechnung,abrechnung_t,preis_cent FROM {pre}mod_premium_packages WHERE id=?',
            $packageID,
        );
        if ($res->RowCount() == 1) {
            $package = $res->FetchArray(MYSQLI_ASSOC);
            ...
            if ($bm_prefs['mwst'] == 'add') {
                $package['preis_cent'] = round(
                    $package['preis_cent'] *
                        (1 + $bm_prefs['steuersatz'] / 100),
                    0,
                );
            }
            $res->Free();
            ...
            if ($package['abrechnung'] == 'einmalig') {
                ...
                if (
                    $abrechnungT % $package['abrechnung_t'] != 0 ||
                    $abrechnungT < 1
                ) {
                    return -1;
                } else {
                    return round(
                        ($abrechnungT / $package['abrechnung_t']) *
                            $package['preis_cent'],
                        0,
                    );
                }
    ...
    function _packagesAvailable() {
        ...
        $res = $db->Query(
            'SELECT COUNT(*) FROM {pre}mod_premium_packages WHERE geloescht=0',
        );
    ...
    function _getUserSubscriptions($userID) {
        ...
        $result = [];
        $res = $db->Query(
            'SELECT id,benutzer,paket,letzte_zahlung,ablauf,last_update_notification FROM {pre}mod_premium_subscribers WHERE benutzer=?',
            $userID,
        );
        while ($row = $res->FetchArray(MYSQLI_ASSOC)) {
    ...
    function _checkUserToken() {
        ...
        // check token
        $res = $db->Query(
            'SELECT COUNT(*) FROM {pre}mod_premium_userauth WHERE userid=? AND token=?',
            $userID,
            $userToken,
        );
    ...
    function _paccPlaceOrder() {
        ...
        // display order page
            ...
            if (
                ...
                $tpl->assign(
                    'page',
                    $this->_templatePath('pacc.nli.order.done.tpl'),
                );
                $tpl->assign('omitTable', true);
            } else {
                $tpl->assign(
                    'page',
                    $this->_templatePath('pacc.nli.order.tpl'),
                );
            }
    ...
    function _abortNLIOrder($userID, $userRow) {
        ...
        if ($this->prefs['signup_order_force'] == 'yes') {
            ...
            PutLog(
                sprintf(
                    'User <%s> (%d) marked for deletion (signup aborted at order page)',
                    $userRow['email'],
                    $userID,
                ),
                PRIO_NOTE,
    ...
    function _vatRateForUser($userID) {
        ...
        $countries = CountryList(true);
        $res = $db->Query(
            'SELECT `land` FROM {pre}users WHERE `id`=?',
            $userID,
        );
        while ($row = $res->FetchArray(MYSQLI_ASSOC)) {
    ...
    function _nliPackagesPage($userID, $signUp = false) {
        ...
        $tpl->assign(
            ...
            $this->prefs['signup_order_force'] == 'yes'
                ? ($signUp
                    ? $lang_user['pacc_forcetext']
                    : $lang_user['pacc_locktext'])
    ...
    function _subscriptionsPage() {
        ...
        if ($_REQUEST['do'] == 'list') {
            // single action
            if (
                isset($_REQUEST['singleAction']) &&
                in_array($_REQUEST['singleAction'], ['extend', 'cancel'])
            ) {
                $_REQUEST['executeMassAction'] = true;
                $_REQUEST['massAction'] = $_REQUEST['singleAction'];
                $_POST['subscriber'] = [(int) $_REQUEST['singleID'] => true];
            }

            // mass action
            if (isset($_REQUEST['executeMassAction'])) {
                // get subscriber IDs
                $subscriberIDs = isset($_POST['subscriber'])
                    ? $_POST['subscriber']
                    : [];
                ...
                if (count($subscriberIDs) > 0) {
                    ...
                    if ($_REQUEST['massAction'] == 'cancel') {
                        $res = $db->Query(
                            'SELECT id,benutzer,paket FROM {pre}mod_premium_subscribers WHERE id IN ?',
                            $subscriberIDs,
                        );
                        while ($row = $res->FetchArray(MYSQLI_ASSOC)) {
                            // get package details
                            ...
                            PutLog(
                                sprintf(
                                    'PremiumAccount: Subscription #%d of user #%d cancelled by admin',
                                    $row['id'],
                                    $row['benutzer'],
                                ),
                                PRIO_NOTE,
                    ...
                    elseif ($_REQUEST['massAction'] == 'extend') {
                        // assign
                        $tpl->assign('ids', implode(',', $subscriberIDs));
                        $tpl->assign(
                            'page',
                            $this->_templatePath(
                                'pacc.admin.subscriptions.extend.tpl',
                            ),
                        );
                        return;
                    }
            ...
            if (
                ...
                if ($_REQUEST['mode'] == 'dynamic') {
                    $time =
                        (int) $_REQUEST['dynamicValue'] *
                        min(365, max(1, (int) $_REQUEST['dynamicFactor'])) *
                        TIME_ONE_DAY;
                    $db->Query(
                        'UPDATE {pre}mod_premium_subscribers SET ablauf=ablauf+? WHERE id IN ? AND ablauf>1',
                        $time,
                        $subscriberIDs,
                    );
                } elseif ($_REQUEST['mode'] == 'static') {
                    $_REQUEST['staticValueHour'] = 23;
                    $_REQUEST['staticValueMinute'] = $_REQUEST[
                        'staticValueSecond'
                    ] = 59;
                    $time = SmartyDateTime('staticValue');
                    $db->Query(
                        'UPDATE {pre}mod_premium_subscribers SET ablauf=? WHERE id IN ?',
                        $time,
                        $subscriberIDs,
                    );
                }
            ...
            if (isset($_REQUEST['filter'])) {
                ...
                $queryPackages =
                    count($packageIDs) > 0 ? implode(',', $packageIDs) : '0';
                $queryAdd = 'WHERE paket IN(' . $queryPackages . ') ';
            }

            // page calculation
            $res = $db->Query(
                'SELECT COUNT(*) FROM {pre}mod_premium_subscribers ' .
                    $queryAdd,
            );
            ...
            $startPos = max(
                0,
                min($perPage * ($pageNo - 1), $subscriptionCount),
            );

            // get packages
            $packages = [];
            $res = $db->Query(
                'SELECT id,titel,geloescht FROM {pre}mod_premium_packages WHERE geloescht=0 ORDER BY titel ASC',
            );
            while ($row = $res->FetchArray(MYSQLI_ASSOC)) {
                $packages[$row['id']] = [
                    'id' => $row['id'],
                    'title' => $row['titel'],
                    'checked' =>
                        !isset($_REQUEST['packages']) ||
                        isset($_REQUEST['packages'][$row['id']]),
            ...
            $subscriptions = [];
            $res = $db->Query(
                'SELECT id,benutzer,paket,letzte_zahlung,ablauf FROM {pre}mod_premium_subscribers ' .
                    $queryAdd .
                    'ORDER BY ' .
                    $sortBy .
                    ' ' .
            ...
            $tpl->assign(
                'page',
                $this->_templatePath('pacc.admin.subscriptions.tpl'),
            );
        }
    }
    ...
    function _prefsPage() {
        ...
        if ($_REQUEST['do'] == 'common') {
            ...
            if (isset($_REQUEST['save'])) {
                $db->Query(
                    'UPDATE {pre}mod_premium_prefs SET delete_order=?, delete_order_after=?, send_update_notification=?, update_notification_days=?, update_notification_altmail=?, signup_order_page=?, signup_order_force=?, nli_packages_page=?',
                    ...
                    isset($_REQUEST['update_notification_altmail'])
                        ? 'yes'
                        : 'no',
        ...
        // feature fields
        //
        elseif ($_REQUEST['do'] == 'featureFields') {
            // save?
            if (isset($_REQUEST['save']) && is_array($_POST['fields'])) {
                $db->Query(
                    'UPDATE {pre}mod_premium_prefs SET `fields`=?,`fields_order`=?',
                ...
                if (
                    !is_array(
                        $fieldValues = @unserialize($this->prefs['fields']),
                    )
                ) {
                    $fieldValues = [];
                }
                if (
                    !is_array(
                        $fieldPositions = @unserialize(
                            $this->prefs['fields_order'],
                        ),
                    )
                ) {
                    $fieldPositions = [];
            ...
            $tpl->assign(
                'page',
                $this->_templatePath('pacc.admin.prefs.featurefields.tpl'),
            );
        }
    }
    ...
    function _packagesPage() {
        ...
        if ($_REQUEST['do'] == 'list') {
            ...
            if (isset($_REQUEST['delete'])) {
                ...
                if (
                    $subscriberCount > 0 &&
                    !isset($_REQUEST['subscriptionAction'])
                ) {
                    // fetch title
                    $res = $db->Query(
                        'SELECT titel FROM {pre}mod_premium_packages WHERE id=?',
                        $id,
                    );
                    ...
                    $tpl->assign(
                        'page',
                        $this->_templatePath('pacc.admin.packages.delete.tpl'),
                    );
                    return;
                } elseif (
                    $subscriberCount > 0 &&
                    ...
                    if ($_REQUEST['subscriptionAction'] == 'continue') {
                        // mark for deletion
                        $db->Query(
                            'UPDATE {pre}mod_premium_packages SET geloescht=1 WHERE id=?',
                            $id,
                        );
                        ...
                        PutLog(
                            sprintf(
                                'Premium package <%d> marked for deletion',
                                $id,
                            ),
                            PRIO_NOTE,
                            __FILE__,
                    ...
                    } elseif ($_REQUEST['subscriptionAction'] == 'delete') {
                        // get fallback group
                        $res = $db->Query(
                            'SELECT fallback_grp FROM {pre}mod_premium_packages WHERE id=?',
                            $id,
                        );
                        ...
                        // process users
                        $res = $db->Query(
                            'SELECT id,benutzer FROM {pre}mod_premium_subscribers WHERE paket=?',
                            $id,
                        );
                        while ($row = $res->FetchArray(MYSQLI_ASSOC)) {
                            if ($fallbackGroup == -1) {
                        ...
                        $db->Query(
                            'DELETE FROM {pre}mod_premium_subscribers WHERE paket=?',
                            $id,
                        );

                        // delete package
                        $db->Query(
                            'DELETE FROM {pre}mod_premium_packages WHERE id=?',
                            $id,
                        );
                        ...
                        PutLog(
                            sprintf(
                                'Premium package <%d> deleted (subscriptions deleted; fallback group: %d)',
                                $id,
                                $fallbackGroup,
                            ),
                            PRIO_NOTE,
                    ...
                    PutLog(
                        sprintf(
                            'Premium package <%d> deleted (no subscriptions)',
                            $id,
                        ),
                        PRIO_NOTE,
                        __FILE__,
            ...
            if (isset($_REQUEST['add'])) {
                ...
                foreach (
                    ...
                    as $descriptionEntryKey => $descriptionEntry
                ) {
                    if (
                        $descriptionEntryKey == 0 ||
                        empty($descriptionEntry['description'])
                    ) {
                        continue;
                    }
                    $altDescriptions[$descriptionEntry['lang']] =
                        $descriptionEntry['description'];
                }

                $db->Query(
                    'INSERT INTO {pre}mod_premium_packages(titel,gruppe,fallback_grp,abrechnung_t,abrechnung,laufzeiten,max_laufzeit,preis_cent,beschreibung,template,accentuation,`order`,`alt_titles`,`alt_descriptions`) ' .
                        'VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?)',
            ...
            $packages = [];
            $res = $db->Query(
                'SELECT {pre}mod_premium_packages.id AS id,' .
            ...
            while ($row = $res->FetchArray(MYSQLI_ASSOC)) {
                ...
                if ($row['fallback_grp'] == -1) {
                    $fallbackGroup =
                        '(' . $lang_admin['pacc_lockaccount'] . ')';
                } else {
                    $groupRes = $db->Query(
                        'SELECT titel FROM {pre}gruppen WHERE id=?',
                        $row['fallback_grp'],
                    );
                ...
                $paymentPeriod = $this->_intervalStr(
                    $row['abrechnung'],
                    $row['abrechnung_t'],
                );
            ...
            $tpl->assign(
                'page',
                $this->_templatePath('pacc.admin.packages.tpl'),
            );
        }
        ...
        elseif ($_REQUEST['do'] == 'edit' && isset($_REQUEST['id'])) {
            ...
            if (isset($_REQUEST['save'])) {
                ...
                // update db
                $db->Query(
                    'UPDATE {pre}mod_premium_packages SET titel=?,gruppe=?,fallback_grp=?,abrechnung_t=?,abrechnung=?,laufzeiten=?,max_laufzeit=?,preis_cent=?,beschreibung=?,template=?,accentuation=?,`order`=?,`alt_titles`=?,`alt_descriptions`=? WHERE id=?',
                    $_REQUEST['titles'][0]['title'],
                    $_REQUEST['gruppe'],
                    $_REQUEST['fallback_grp'],
                    $_REQUEST['abrechnung_t'],
                ...
                // redirect
                header(
                    'Location: ' . $this->_adminLink(true) . '&action=packages',
                );
                exit();
            }
            ...
            // fetch
            $res = $db->Query(
                'SELECT id,titel,gruppe,fallback_grp,abrechnung_t,abrechnung,laufzeiten,max_laufzeit,preis_cent,beschreibung,template,accentuation,`order`,`alt_titles`,`alt_descriptions` FROM {pre}mod_premium_packages WHERE id=?',
                (int) $_REQUEST['id'],
            );
            $package = $res->FetchArray(MYSQLI_ASSOC);
            $res->Free();
            ...
            $tpl->assign(
                'page',
                $this->_templatePath('pacc.admin.packages.edit.tpl'),
            );
        }
    }
    ...
    function _overviewPage() {
        ...
        // overall revenue
        $res = $db->Query(
            'SELECT SUM(amount) FROM {pre}orders WHERE status=1 AND cart LIKE \'%PAcc.order.%\'',
        );
        ...
        // month revenue
        $res = $db->Query(
            'SELECT SUM(amount) FROM {pre}orders WHERE status=1 AND cart LIKE \'%PAcc.order.%\' AND activated>?',
        ...
        $res = $db->Query(
            'SELECT COUNT(*),SUM(amount) FROM {pre}orders WHERE status=0 AND cart LIKE \'%PAcc.order.%\'',
        );
        [$outstandingPaymentsCount, $outstandingPaymentsSum] = $res->FetchArray(
            MYSQLI_NUM,
        );
        $res->Free();
        ...
        $res = $db->Query(
            'SELECT COUNT(*),SUM(amount) FROM {pre}orders WHERE status=0 AND cart LIKE \'%PAcc.order.%\' AND paymethod=?',
            PAYMENT_METHOD_BANKTRANSFER,
        );
        [$advancePaymentsCount, $advancePaymentsSum] = $res->FetchArray(
            MYSQLI_NUM,
        );
        $res->Free();
        ...
        [$paypalPaymentsCount, $paypalPaymentsSum] = $res->FetchArray(
            MYSQLI_NUM,
        );
        $res->Free();
        ...
        $tpl->assign(
            'overallRevenue',
            sprintf('%.02f %s', $overallRevenue / 100, $bm_prefs['currency']),
        );
        $tpl->assign(
            'monthRevenue',
            sprintf('%.02f %s', $monthRevenue / 100, $bm_prefs['currency']),
        );
        $tpl->assign(
            'outstandingPayments',
            sprintf(
    ...
    function _smartyPaccFormatField($params, &$smarty) {
        ...
        if (isset($groupOptions[$key])) {
            ...
            if (
                ...
                return TemplateSize(['bytes' => $value], $smarty);
            } elseif (in_array($key, ['wd_member_kbs', 'wd_open_kbs'])) {
                return sprintf('%d KB/s', $value);
            } elseif ($key == 'sms_monat') {
                return sprintf('%d %s', $value, $lang_user['credits']);
            } elseif ($key == 'sms_price_per_credit') {
                return sprintf('%.02f %s', $value / 100, $bm_prefs['currency']);
            } elseif (in_array($key, ['sms_sig', 'signatur'])) {
                return trim($value) == ''
                    ? $lang_user['none']
                    : TemplateText($params, $smarty);
            } elseif ($key == 'saliase' || $key == 'sms_pre') {
        ...
        if ($value == 'yes' || $value == 'no') {
            if (!isset($userRow)) {
                ...
                return sprintf(
                    '<span class="fa fa-%s" style="color:%s;" />',
