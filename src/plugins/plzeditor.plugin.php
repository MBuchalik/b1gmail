...
class PLZEditorPlugin extends BMPlugin {
    ...
    function OnReadLang(
        ...
        if ($lang == 'deutsch') {
            ...
            $lang_admin['plzeditor_test_success'] =
                'Das PLZ/Ort-Paar &quot;%s %s&quot; wurde in der PLZ-Datenbank von %s gefunden.';
            $lang_admin['plzeditor_test_error'] =
                'Das PLZ/Ort-Paar &quot;%s %s&quot; wurde <b>nicht</b> in der PLZ-Datenbank von %s gefunden.';
            $lang_admin['plzeditor_add_success'] =
                'Das PLZ/Ort-Paar &quot;%s %s&quot; wurde in die PLZ-Datenbank von %s eingef&uuml;gt.';
            $lang_admin['plzeditor_add_error'] =
                'Das PLZ/Ort-Paar konnte nicht hinzugef&uuml;gt werden. Bitte stellen Sie sicher, dass die Datei <code>%s</code> Schreibrechte hat (CHMOD 777).';
        } else {
            ...
            $lang_admin['plzeditor_test_success'] =
                'The ZIP/city pair &quot;%s %s&quot; exists in the ZIP database of %s.';
            $lang_admin['plzeditor_test_error'] =
                'The ZIP/city pair &quot;%s %s&quot; <b>does not</b> exist in the ZIP database of %s.';
            $lang_admin['plzeditor_add_success'] =
                'The ZIP/city pair &quot;%s %s&quot; has been added to the ZIP database of %s.';
            $lang_admin['plzeditor_add_error'] =
                'The ZIP/city pair could not be added. Please ensure that the file <code>%s</code> has write permissions (CHMOD 777).';
        }
    }
