...
class BMHTTP_POST extends BMHTTP {
     ...
     * @return string
     */
    function DownloadToString_POST(
        $postData,
        ...
        // fetch
        $this->_fp = fsockopen(
            ($this->_protocol == 'https' ? 'ssl://' : '') . $this->_host,
            $this->_port,
            $errNo,
            $errStr,
            SOCKET_TIMEOUT,
...
class FaxPlugin extends BMPlugin {
    ...
    function Install() {
        ...
        if ($prefsCount == 0) {
            ...
            $db->Query(
                'INSERT INTO {pre}modfax_prefixes(`prefixid`,`country_prefix`,`prefix`,`faxgateid`,`price_firstpage`,`price_nextpages`) VALUES(\'1\',\'49\',\'*\',\'0\',\'3\',\'2\')',
            );
            $db->Query(
                'INSERT INTO {pre}modfax_prefixes(`prefixid`,`country_prefix`,`prefix`,`faxgateid`,`price_firstpage`,`price_nextpages`) VALUES(\'2\',\'49\',\'18\',\'0\',\'10\',\'9\')',
            );
            $db->Query(
                'INSERT INTO {pre}modfax_prefixes(`prefixid`,`country_prefix`,`prefix`,`faxgateid`,`price_firstpage`,`price_nextpages`) VALUES(\'3\',\'49\',\'90\',\'-1\',\'0\',\'0\')',
            );
            $db->Query(
                'INSERT INTO {pre}modfax_prefixes(`prefixid`,`country_prefix`,`prefix`,`faxgateid`,`price_firstpage`,`price_nextpages`) VALUES(\'4\',\'49\',\'19\',\'-1\',\'0\',\'0\')',
            );
            $db->Query(
                'INSERT INTO {pre}modfax_prefixes(`prefixid`,`country_prefix`,`prefix`,`faxgateid`,`price_firstpage`,`price_nextpages`) VALUES(\'5\',\'49\',\'13\',\'-1\',\'0\',\'0\')',
            );
            $db->Query(
                'INSERT INTO {pre}modfax_prefixes(`prefixid`,`country_prefix`,`prefix`,`faxgateid`,`price_firstpage`,`price_nextpages`) VALUES(\'6\',\'*\',\'*\',\'0\',\'5\',\'4\')',
            );
            $db->Query(
                'INSERT INTO {pre}modfax_prefixes(`prefixid`,`country_prefix`,`prefix`,`faxgateid`,`price_firstpage`,`price_nextpages`) VALUES(\'16\',\'49\',\'14\',\'-1\',\'0\',\'0\')',
            );
            $db->Query(
                'INSERT INTO {pre}modfax_prefixes(`prefixid`,`country_prefix`,`prefix`,`faxgateid`,`price_firstpage`,`price_nextpages`) VALUES(\'15\',\'49\',\'12\',\'-1\',\'3\',\'2\')',
            );
            $db->Query(
                'INSERT INTO {pre}modfax_prefixes(`prefixid`,`country_prefix`,`prefix`,`faxgateid`,`price_firstpage`,`price_nextpages`) VALUES(\'14\',\'49\',\'11\',\'-1\',\'0\',\'0\')',
            );
            $db->Query(
                'INSERT INTO {pre}modfax_prefixes(`prefixid`,`country_prefix`,`prefix`,`faxgateid`,`price_firstpage`,`price_nextpages`) VALUES(\'13\',\'49\',\'10\',\'-1\',\'0\',\'0\')',
            );
            $db->Query(
                'INSERT INTO {pre}modfax_signatures(`signatureid`,`groups`,`paused`,`weight`,`counter`,`fontname`,`fontsize`,`align`,`style`,`text`,`showon`,`margin`) VALUES(\'1\',\'*\',\'0\',\'100\',\'0\',\'arial\',\'8\',\'L\',\'13\',\'powered by b1gMail\r\nhttps://www.b1gmail.org/\',\'11\',\'25\')',
            );
            $db->Query(
                'INSERT INTO {pre}modfax_prefs(`allow_ownname`,`allow_ownno`,`allow_pdf`,`default_name`,`default_no`,`send_safecode`,`default_country_prefix`,`default_faxgateid`,`refund_on_error`) VALUES(\'1\',\'1\',\'1\',\'\',\'\',\'0\',\'49\',\'2\',\'1\')',
            );
        }
    ...
    function OnReadLang(
        ...
        if ($lang == 'deutsch') {
            ...
            $_lang_admin['modfax_fpdferror'] =
                'FPDF/FPDI ist nicht installiert, wird aber vom Fax-Plugin zwingend zum Versand von Faxen ben&ouml;tigt. Bitte lesen Sie die Fax-Plugin-Dokumentation, um zu erfahren, wie Sie FPDF/FPDI installieren.';
            ...
            $_lang_admin['modfax_number_internat_00'] =
                'International mit 00 (z.B. 004912345678)';
            $_lang_admin['modfax_number_internat_plus'] =
                'International mit + (z.B. +4912345678)';
            $_lang_admin['modfax_number_internat_none'] =
                'International ohne Prefix (z.B. 4912345678)';
            $_lang_admin['modfax_number_nat'] =
                'Ohne internat. Vorwahl (z.B. 012345678)';
            ...
            $_lang_admin['modfax_gateways_advanced'] =
                'Gateways (erweiterter Modus)';
            $_lang_admin['modfax_gateways_simple'] =
                'Gateways (vereinfachter Modus)';
            ...
            $_lang_admin['modfax_creditsmonth'] =
                'Abgerechnete Cred. (dieser Monat)';
            $_lang_admin['modfax_creditsall'] =
                'Abgerechnete Cred. (insgesamt)';
            $_lang_admin['modfax_refundstoday'] =
                'R&uuml;ckerstattungen (Cred., heute)';
            $_lang_admin['modfax_refundsmonth'] =
                'R&uuml;ckerstattungen (Cred., dieser Monat)';
            $_lang_admin['modfax_refundsall'] =
                'R&uuml;ckerstattungen (Cred., insgesamt)';
            $_lang_admin['modfax_errtoday'] =
                '&Uuml;bertragungs-Fehler (heute)';
            $_lang_admin['modfax_errmonth'] =
                '&Uuml;bertragungs-Fehler (dieser Monat)';
            $_lang_admin['modfax_errall'] =
                '&Uuml;bertragungs-Fehler (insgesamt)';
            $_lang_admin['modfax_perms'] = 'Berechtigungen';
            $_lang_admin['modfax_refund_on_error'] =
                'R&uuml;ckerstattung bei Fehler';
            ...
            $_lang_user['modfax_txrefundtext'] =
                'Rückerstattung (Fax-Versand fehlgeschlagen)';
            ...
            $_lang_user['modfax_browsetext'] =
                'Bitte w&auml;hlen Sie die PDF-Datei aus, die Sie an Ihr Fax anh&auml;ngen m&ouml;chten. Sie k&ouml;nnen eine Datei von Ihrem Computer oder von Ihrer Webdisk (falls vorhanden) ausw&auml;hlen.';
            $_lang_user['modfax_pdferror'] =
                'Die Datei ist keine gültige PDF-Datei oder verschlüsselt/geschützt.';
            $_lang_user['modfax_pdfpageerror'] =
                'Die PDF-Datei konnte aus unbekannten Gründen nicht verarbeitet werden.';
            ...
            $_lang_user['modfax_previewtext'] =
                'Ihr Fax wurde erfolgreich zum Versand vorbereitet. Im Folgenden k&ouml;nnen Sie eine Vorschau (PDF-Datei) des Faxes herunterladen und Sie sehen die Seitenanzahl des Faxes sowie den Preis (in Credits), der bei Versand f&auml;llig wird.';
            $_lang_user['modfax_previewtext2'] =
                'Wenn Sie das Fax absenden m&ouml;chten, klicken Sie bitte auf &quot;Fax senden&quot;. Stellen Sie vorher sicher, dass Ihr Credit-Guthaben zum Versand ausreicht.';
            $_lang_user['modfax_toerr'] =
                'Die angegebene Empf&auml;nger-Nummer ist ung&uuml;ltig. Bitte pr&uuml;fen Sie Ihre Eingabe und versuchen Sie es erneut.';
            $_lang_user['modfax_toforbiddenerr'] =
                'Es k&ouml;nnen leider keine Faxe an die angegebene Nummer bzw. an die angegebene Vorwahl gesendet werden.';
            $_lang_user['modfax_sent'] =
                'Das Fax wurde erfolgreich verschickt.';
            $_lang_user['modfax_sendfailed'] =
                'Das Fax konnte nicht gesendet werden. M&ouml;gliche Ursache ist ein zu kleines Guthaben oder ein tempor&auml;rer interner Fehler. Bitte versuchen Sie es sp&auml;ter erneut.';
            ...
            $_lang_user['modfax_fromerr'] =
                'Der angegebene Absender-Name bzw. die angegebene Absender-Nummer ist ung&uuml;ltig. Bitte pr&uuml;fen Sie Ihre Eingabe und versuchen Sie es erneut.';
        ...
        //
            ...
            $_lang_admin['modfax_fpdferror'] =
                'FPDF/FPDI is not installed properly, but is required by the Fax plugin to create faxes. Please read the documentation of the Fax plugin on how to install FPDF/FPDI.';
            ...
            $_lang_admin['modfax_number_internat_00'] =
                'International with 00 (e.g. 004912345678)';
            $_lang_admin['modfax_number_internat_plus'] =
                'International with + (e.g. +4912345678)';
            $_lang_admin['modfax_number_internat_none'] =
                'International without 00/+ (e.g. 4912345678)';
            $_lang_admin['modfax_number_nat'] =
                'Without internat. prefix (e.g.. 012345678)';
            ...
            $_lang_user['modfax_browsetext'] =
                'Please select the PDF file you would like to attach to your fax. You can chose a file from your computer or from your webdisk (if available).';
            $_lang_user['modfax_pdferror'] =
                'The file is not in PDF format or encrypted/protected.';
            $_lang_user['modfax_pdfpageerror'] =
                'The PDF file could not be processed for unknown reasons.';
            ...
            $_lang_user['modfax_previewtext'] =
                'Your fax has been prepared for sending. Here you can download the preview for your fax (PDF file) and you can see the page count and price (in credits) of your fax.';
            $_lang_user['modfax_previewtext2'] =
                'If you would like to send the fax, click at &quot;Send fax&quot;. Please ensure that you have enough credits first.';
            $_lang_user['modfax_toerr'] =
                'The recipient no is invalid. Please check your input and try again.';
            $_lang_user['modfax_toforbiddenerr'] =
                'Unfortunately we cannot process faxes to this number at this time.';
            $_lang_user['modfax_sent'] = 'The fax has been sent successfuly.';
            $_lang_user['modfax_sendfailed'] =
                'The fax could not been sent. Possible causes are too less credits or a temporary internal problem. Please try again later.';
            ...
            $_lang_user['modfax_fromerr'] =
                'The sender name/no is invalid. Please check your input and try again.';
    ...
    function ToolInterfaceCheckLogin($user) {
        ...
        $faxEnabled =
            $this->GetGroupOptionValue('fax', $groupID) &&
            $this->GetGroupOptionValue('tbx_fax', $groupID);
        $result = ['faxAccess' => $faxEnabled];
    ...
    function ToolInterfaceHandler($method, $params, &$result, &$ti) {
        $supportedMethods = ['GetFaxPrice', 'SendFax'];
        ...
        if (
            $userInfo['loginOK'] > 0 &&
            $userInfo['plugins']['FaxPlugin']['faxAccess']
        ) {
            ...
            elseif ($method == 'SendFax') {
                ...
                if ($fileSize > 10) {
                    // prepare params
                    $fromName = $this->prefs['allow_ownname']
                        ? $fromName
                        : $this->prefs['default_name'];
                    $fromNo = $this->prefs['allow_ownno']
                        ? $fromNo
                        : $this->prefs['default_no'];
                    ...
                    if ($to) {
                        ...
                        if ($fpIn && $fpOut) {
                            ...
                            // send fax
                            $thisUser = _new('BMUser', [$userInfo['userID']]);
                            if (
                                $this->_sendFax(
                                    $tempFileID,
                                    $fromName,
    ...
    function OnReceiveMail(&$mail, &$mailbox, &$user) {
        ...
        $res = $db->Query(
            'SELECT `faxgateid`,`status_prefs` FROM {pre}modfax_gateways WHERE `status_mode`=?',
        ...
        while ($row = $res->FetchArray(MYSQLI_ASSOC)) {
            ...
            $emailTo = str_replace(
                '%%answer_email%%',
                $this->_answerEMailAddr($row['faxgateid']),
                $statusPrefs['emailto'],
            );
    ...
    function FileHandler($file, $action) {
        ...
        if (
            $file == 'index.php' &&
            strpos($_SERVER['REQUEST_URI'], '/faxPluginStatusPush/') !== false
        ) {
        ...
        $tpl->assign(
            'pageMenuFile',
            $this->_templatePath('modfax.user.sidebar.tpl'),
        );
        ...
        } elseif ($_REQUEST['do'] == 'addressBook') {
            $this->_addressBookUserPage();
        } elseif ($_REQUEST['do'] == 'outbox') {
    ...
    function _httpStatusPush() {
        ...
        while ($row = $res->FetchArray(MYSQLI_ASSOC)) {
            ...
            if (
                !isset($_REQUEST[$statusPrefs['code_param']]) ||
            ...
            $res2 = $db->Query(
                'SELECT COUNT(*) FROM {pre}modfax_outbox WHERE `statuscode`=? AND `faxgateid`=?',
                $statusCode,
                $row['faxgateid'],
            );
            [$outboxCount] = $res2->FetchArray(MYSQLI_NUM);
            $res2->Free();
            ...
            $success = preg_match(
                '/' . $statusPrefs['result_regex'] . '/',
                $_REQUEST[$statusPrefs['result_param']],
            );
    ...
    function _outboxUserPage() {
        ...
        if (isset($_REQUEST['delete'])) {
            // delete pdf file
            $res = $db->Query(
                'SELECT `diskfileid` FROM {pre}modfax_outbox WHERE `userid`=? AND `faxid`=?',
                $userRow['id'],
                (int) $_REQUEST['delete'],
            );
            while ($row = $res->FetchArray(MYSQLI_ASSOC)) {
            ...
            // delete outbox entry
            $db->Query(
                'DELETE FROM {pre}modfax_outbox WHERE `userid`=? AND `faxid`=?',
                $userRow['id'],
                (int) $_REQUEST['delete'],
            );
        }
        ...
        // get fax count
        $res = $db->Query(
            'SELECT COUNT(*) FROM {pre}modfax_outbox WHERE `userid`=?',
            $userRow['id'],
        );
        [$faxCount] = $res->FetchArray(MYSQLI_NUM);
        $res->Free();
        ...
        // get sort info
        $sortColumns = ['tono', 'pages', 'date', 'status'];
        $sortColumn =
            isset($_REQUEST['sort']) &&
        ...
        $outbox = [];
        $res = $db->Query(
            'SELECT * FROM {pre}modfax_outbox WHERE `userid`=? ORDER BY `' .
                $sortColumn .
                '` ' .
                $sortOrder .
                ' LIMIT ' .
                (int) (($pageNo - 1) * $entriesPerPage) .
                ', ' .
                (int) $entriesPerPage,
            $userRow['id'],
        );
        while ($row = $res->FetchArray(MYSQLI_ASSOC)) {
            $row['fileAvailable'] =
                $webdisk->GetFileInfo($row['diskfileid']) !== false;
        ...
        $tpl->assign(
            'pageContent',
            $this->_templatePath('modfax.user.outbox.tpl'),
        );
    ...
    function _composeUserPage() {
        ...
        if (!isset($_REQUEST['do2'])) {
            if (
                !is_array(
                    $defaultTemplate = @unserialize(
                        $this->prefs['default_template'],
                    ),
                )
            ) {
                $defaultTemplate = [0 => MODFAX_BLOCK_TEXT];
            }
            ...
            $tpl->assign(
                'pageContent',
                $this->_templatePath('modfax.user.compose.tpl'),
            );
            $tpl->display('li/index.tpl');
        } elseif ($_REQUEST['do2'] == 'prepareSend') {
            echo '<script>' . "\n";
            echo '<!--' . "\n";
            ...
            $fromName =
                $this->prefs['allow_ownname'] && isset($_REQUEST['fromname'])
                    ? $_REQUEST['fromname']
                    : $this->prefs['default_name'];
            $fromNo =
                $this->prefs['allow_ownno'] && isset($_REQUEST['fromno'])
                    ? $_REQUEST['fromno']
                    : $this->prefs['default_no'];
            $toNo = $_REQUEST['to'];
            ...
            // check 'from' number
            if (
                ($this->prefs['allow_ownno'] && strlen(trim($fromNo)) < 4) ||
                ...
                if ($to) {
                    // generate PDF file
                    $pageCount = 0;
                    $pdfTempFileID = $this->_generatePDF(
                        $fromName,
                        $fromNo,
                        $toNo,
                        $_REQUEST['block'],
                    ...
                    if ($faxPrice === false) {
                        ...
                        // switch to step 2
                        printf(
                            '    parent.window.faxFormStep2(%d, %d, %d);' .
                                "\n",
                            $pdfTempFileID,
                            $pageCount,
                            $faxPrice,
            ...
            if ($error) {
                printf(
                    '    parent.window.faxFormSetError(\'%s\');' . "\n",
                    addslashes($error),
                );
            }
            ...
            echo '//-->' . "\n";
            echo '</script>' . "\n";
        } elseif ($_REQUEST['do2'] == 'send' && isset($_REQUEST['fileID'])) {
            ...
            if ($this->prefs['send_safecode']) {
                ...
                // < v7.4
                    ...
                    if (
                        strlen(
                            $code = Safecode::GetCode(
                                (int) $_REQUEST['codeID'],
                            ),
                        ) >= 4 &&
                        trim(strtolower($_REQUEST['safecode'])) ==
                            strtolower($code)
                    ) {
                        $captchaOK = true;
                    }
            ...
            if (!$captchaOK) {
                ...
                if ($result) {
                    ...
                    $tpl->assign(
                        'backLink',
                        'start.php?action=faxPlugin&sid=' . session_id(),
                    );
            ...
            header(
                'Content-Disposition: attachment; filename="fax-preview.pdf"',
            );
            ...
            exit();
        } elseif ($_REQUEST['do2'] == 'getFormBlockCode') {
            $tpl->assign('faxPrefs', $this->prefs);
            $tpl->assign('userRow', $userRow);
            $tpl->display(
                $this->_templatePath('modfax.user.compose.block.tpl'),
            );
        } elseif (
            $_REQUEST['do2'] == 'addPDFFile' &&
            ...
            $tpl->assign(
                'formAction',
                'start.php?action=faxPlugin&do2=uploadPDFFile&blockID=' .
                    (int) $_REQUEST['blockID'] .
                    '&sid=' .
                    session_id(),
            );
            ...
            $_REQUEST['do2'] == 'uploadPDFFile' &&
            isset($_REQUEST['blockID'])
        ) {
            $blockID = (int) $_REQUEST['blockID'];
            $tempFileID = RequestTempFile(
                $userRow['id'],
                time() + 4 * TIME_ONE_HOUR,
            );
            $tempFileName = TempFileName($tempFileID);
            ...
            if (!$file) {
                ...
                if (
                    ...
                    // ok?
                    if ($pageCount >= 1) {
                        echo 'parent.document.getElementById(\'block_' .
                            $blockID .
                            '_filename\').innerHTML = \'' .
    ...
    function AdminHandler() {
        ...
        } elseif ($_REQUEST['action'] == 'prefixes') {
    ...
    function _getStatData($type, $time) {
        ...
        for (
            ...
            $res = $db->Query(
                'SELECT SUM(`count`) FROM {pre}modfax_stats WHERE `d`=? AND `m`=? AND `y`=? AND `type`=?',
                $i,
                date('m', $time),
                date('Y', $time),
                $type,
    ...
    function _statsAdminPage() {
        ...
        if (
            ...
            $chart = new BMChart(
                sprintf(
                    '%s (%d/%d)',
                    $lang_admin['modfax_stat_' . $statTypeItem],
                    date('m', $time),
                    date('Y', $time),
                ),
                520,
        ...
        $statsSpecial = [
            'faxes' => [
                MODFAX_EVENT_SENDFAX,
                MODFAX_EVENT_FAX_OK,
                MODFAX_EVENT_FAX_ERROR,
            ],
            'credits' => [MODFAX_EVENT_CREDITS, MODFAX_EVENT_REFUNDS],
        ];
    ...
    function _prefsAdminPage() {
        ...
        if (isset($_REQUEST['save'])) {
            $defaultCountryPrefix = preg_replace(
                '/^(\+|00|0)/',
                '',
                $_REQUEST['default_country_prefix'],
            );

            if (
                isset($_REQUEST['tpl_blocks']) &&
                is_array($_REQUEST['tpl_blocks']) &&
                count($_REQUEST['tpl_blocks']) > 0
            ) {
                $defaultTemplate = [];
                $i = 0;
            ...
            if (
                ...
                !is_array($defaultTemplate) ||
                count($defaultTemplate) < 1
            ) {
                $defaultTemplate = [0 => MODFAX_BLOCK_TEXT];
            }

            $db->Query(
                'UPDATE {pre}modfax_prefs SET `allow_ownname`=?,`allow_ownno`=?,`allow_pdf`=?,`default_name`=?,`default_no`=?,`send_safecode`=?,`default_country_prefix`=?,`default_faxgateid`=?,`refund_on_error`=?,`default_template`=?',
        ...
        $gateways = [];
        $res = $db->Query(
            'SELECT `faxgateid`,`title` FROM {pre}modfax_gateways ORDER BY `title` ASC',
        );
        while ($row = $res->FetchArray(MYSQLI_ASSOC)) {
    ...
    function _getOverviewStats($event) {
        ...
        [$today] = $res->FetchArray(MYSQLI_NUM);
        $res->Free();

        $res = $db->Query(
            'SELECT SUM(`count`) FROM {pre}modfax_stats WHERE `m`=? AND `y`=? AND `type`=?',
            (int) date('m'),
            (int) date('Y'),
            $event,
        );
        [$month] = $res->FetchArray(MYSQLI_NUM);
        $res->Free();

        $res = $db->Query(
            'SELECT SUM(`count`) FROM {pre}modfax_stats WHERE `type`=?',
            $event,
        );
        [$all] = $res->FetchArray(MYSQLI_NUM);
        $res->Free();
    ...
    function _overviewAdminPage() {
        ...
        // stats: fax
        [$faxToday, $faxMonth, $faxAll] = $this->_getOverviewStats(
            MODFAX_EVENT_SENDFAX,
        );

        // stats: fax errors
        [$errToday, $errMonth, $errAll] = $this->_getOverviewStats(
            MODFAX_EVENT_FAX_ERROR,
        );

        // stats: credits
        [$creditsToday, $creditsMonth, $creditsAll] = $this->_getOverviewStats(
            MODFAX_EVENT_CREDITS,
        );

        // stats: refunded credits
        [$refundsToday, $refundsMonth, $refundsAll] = $this->_getOverviewStats(
            MODFAX_EVENT_REFUNDS,
        );
    ...
    function _signaturesAdminPage() {
        ...
        if ($_REQUEST['do'] == 'overview') {
            ...
            if (isset($_REQUEST['add'])) {
                $groups = is_array($_REQUEST['groups'])
                ...
                if (
                    isset($_REQUEST['showon']) &&
                    is_array($_REQUEST['showon'])
                ) {
                ...
                $db->Query(
                    'INSERT INTO {pre}modfax_signatures(`groups`,`paused`,`weight`,`fontname`,`fontsize`,`align`,`style`,`text`,`showon`,`margin`) ' .
                        'VALUES(?,?,?,?,?,?,?,?,?,?)',
                    $groups,
            ...
            if (isset($_REQUEST['deactivate'])) {
                $db->Query(
                    'UPDATE {pre}modfax_signatures SET `paused`=1 WHERE `signatureid`=?',
            ...
            if (isset($_REQUEST['activate'])) {
                $db->Query(
                    'UPDATE {pre}modfax_signatures SET `paused`=0 WHERE `signatureid`=?',
            ...
            if (isset($_REQUEST['delete'])) {
                $db->Query(
                    'DELETE FROM {pre}modfax_signatures WHERE `signatureid`=?',
                    (int) $_REQUEST['delete'],
                );
            }
            ...
            if (
                ...
                $_REQUEST['massAction'] != '-' &&
                isset($_REQUEST['sigs']) &&
                is_array($_REQUEST['sigs'])
            ) {
                $sigs = $_REQUEST['sigs'];

                if ($_REQUEST['massAction'] == 'pause') {
                    $db->Query(
                        'UPDATE {pre}modfax_signatures SET `paused`=1 WHERE `signatureid` IN ?',
                        $sigs,
                    );
                } elseif ($_REQUEST['massAction'] == 'continue') {
                    $db->Query(
                        'UPDATE {pre}modfax_signatures SET `paused`=0 WHERE `signatureid` IN ?',
                        $sigs,
                    );
                } elseif ($_REQUEST['massAction'] == 'delete') {
                    $db->Query(
                        'DELETE FROM {pre}modfax_signatures WHERE `signatureid` IN ?',
                        $sigs,
                    );
                }
            }
            ...
            $signatures = [];
            $res = $db->Query(
                'SELECT * FROM {pre}modfax_signatures ORDER BY `text` ASC',
            );
            while ($row = $res->FetchArray(MYSQLI_ASSOC)) {
            ...
            $tpl->assign(
                'page',
                $this->_templatePath('modfax.admin.signatures.tpl'),
            );
            ...
            if (isset($_REQUEST['save'])) {
                ...
                $db->Query(
                    'UPDATE {pre}modfax_signatures SET `groups`=?,`paused`=?,`weight`=?,`fontname`=?,`fontsize`=?,`align`=?,`style`=?,`text`=?,`showon`=?,`margin`=? WHERE `signatureid`=?',
                    $groups,
                    isset($_REQUEST['paused']) ? 1 : 0,
                    (int) $_REQUEST['weight'],
                    $_REQUEST['fontname'],
            ...
            // fetch
            $res = $db->Query(
                'SELECT * FROM {pre}modfax_signatures WHERE `signatureid`=?',
                (int) $_REQUEST['id'],
            );
            if ($res->RowCount() != 1) {
                die('Invalid ID');
            ...
            $tpl->assign(
                'page',
                $this->_templatePath('modfax.admin.signatures.edit.tpl'),
            );
        }
    }
    ...
    function _prefixesAdminPage() {
        ...
        if ($_REQUEST['do'] == 'overview') {
            // add?
            if (isset($_REQUEST['add'])) {
                $countryPrefix = preg_replace(
                    '/^(\+|00|0)/',
                    '',
                    $_REQUEST['country_prefix'],
                );
                $prefix = preg_replace('/^(\+|00|0)/', '', $_REQUEST['prefix']);

                $db->Query(
                    'INSERT INTO {pre}modfax_prefixes(`country_prefix`,`prefix`,`faxgateid`,`price_firstpage`,`price_nextpages`) VALUES(?,?,?,?,?)',
                    $countryPrefix,
                    $prefix,
            ...
            if (isset($_REQUEST['delete'])) {
                $db->Query(
                    'DELETE FROM {pre}modfax_prefixes WHERE `prefixid`=?',
                    (int) $_REQUEST['delete'],
                );
            }
            ...
            if (
                isset($_REQUEST['massAction']) &&
                $_REQUEST['massAction'] == 'delete' &&
                isset($_REQUEST['prefixes']) &&
                is_array($_REQUEST['prefixes'])
            ) {
                $db->Query(
                    'DELETE FROM {pre}modfax_prefixes WHERE `prefixid` IN ?',
                    $_REQUEST['prefixes'],
                );
            }
            ...
            $prefixes = [];
            $res = $db->Query(
                'SELECT * FROM {pre}modfax_prefixes ORDER BY `country_prefix` ASC,`prefix` ASC',
            );
            while ($row = $res->FetchArray(MYSQLI_ASSOC)) {
            ...
            $tpl->assign(
                'page',
                $this->_templatePath('modfax.admin.prefixes.tpl'),
            );
        } elseif ($_REQUEST['do'] == 'edit' && isset($_REQUEST['id'])) {
            // save?
            if (isset($_REQUEST['save'])) {
                ...
                $db->Query(
                    'UPDATE {pre}modfax_prefixes SET `country_prefix`=?,`prefix`=?,`faxgateid`=?,`price_firstpage`=?,`price_nextpages`=? WHERE `prefixid`=?',
                    $countryPrefix,
                    $prefix,
                    (int) $_REQUEST['faxgateid'],
                    (int) $_REQUEST['price_firstpage'],
            ...
            // fetch
            $res = $db->Query(
                'SELECT * FROM {pre}modfax_prefixes WHERE `prefixid`=?',
                (int) $_REQUEST['id'],
            );
            if ($res->RowCount() != 1) {
                die('Invalid ID');
            ...
            $tpl->assign(
                'page',
                $this->_templatePath('modfax.admin.prefixes.edit.tpl'),
            );
        }
    }
    ...
    function _simpleGatewaysAdminPage() {
        ...
        if (
            isset($_REQUEST['save']) &&
            isset($_REQUEST['gateways']) &&
            is_array($_REQUEST['gateways'])
        ) {
            foreach ($_REQUEST['gateways'] as $gatewayID => $gatewayPrefs) {
                $db->Query(
                    'UPDATE {pre}modfax_gateways SET `user`=?,`pass`=? WHERE `faxgateid`=?',
                    $gatewayPrefs['user'],
                    $gatewayPrefs['pass'],
                    $gatewayID,
                );
        ...
        $gateways = [];
        $res = $db->Query(
            'SELECT `faxgateid`,`title`,`protocol`,`user`,`pass` FROM {pre}modfax_gateways ORDER BY `title` ASC',
        );
        while ($row = $res->FetchArray(MYSQLI_ASSOC)) {
            $row['default'] =
                $this->prefs['default_faxgateid'] == $row['faxgateid'];
        ...
        $tpl->assign(
            'page',
            $this->_templatePath('modfax.admin.gateways.simple.tpl'),
        );
    }
    ...
    function _gatewaysAdminPage() {
        ...
        if ($_REQUEST['do'] == 'overview') {
            ...
            if (isset($_REQUEST['add'])) {
                ...
                } elseif ((int) $_REQUEST['protocol'] == MODFAX_PROTOCOL_HTTP) {
                ...
                if ((int) $_REQUEST['status_mode'] == MODFAX_STATUSMODE_EMAIL) {
                    ...
                    $statusPrefs['emailsubject'] =
                        $_REQUEST['status_emailsubject'];
                    $statusPrefs['code_field'] = $_REQUEST['status_code_field'];
                    $statusPrefs['success_field'] =
                        $_REQUEST['status_success_field'];
                    $statusPrefs['code_regex'] = $_REQUEST['status_code_regex'];
                    $statusPrefs['success_regex'] =
                        $_REQUEST['status_success_regex'];
                } elseif (
                    (int) $_REQUEST['status_mode'] == MODFAX_STATUSMODE_HTTP
                ) {
                    $statusMode = MODFAX_STATUSMODE_HTTP;
                    $statusPrefs['code_param'] = $_REQUEST['status_code_param'];
                    $statusPrefs['result_param'] =
                        $_REQUEST['status_result_param'];
                    $statusPrefs['result_regex'] =
                        $_REQUEST['status_result_regex'];
                }

                $db->Query(
                    'INSERT INTO {pre}modfax_gateways(`title`,`number_format`,`status_mode`,`status_prefs`,`protocol`,`prefs`,`user`,`pass`) VALUES(?,?,?,?,?,?,?,?)',
                    $_REQUEST['title'],
            ...
            if (isset($_REQUEST['delete'])) {
                $db->Query(
                    'UPDATE {pre}modfax_prefixes SET `faxgateid`=0 WHERE `faxgateid`=?',
                    $_REQUEST['delete'],
                );
                $db->Query(
                    'DELETE FROM {pre}modfax_gateways WHERE `faxgateid`=?',
                    $_REQUEST['delete'],
                );
            }
            ...
            if (
                ...
                $db->Query(
                    'UPDATE {pre}modfax_prefixes SET `faxgateid`=0 WHERE `faxgateid` IN ?',
                    $_REQUEST['gateways'],
                );
                $db->Query(
                    'DELETE FROM {pre}modfax_gateways WHERE `faxgateid` IN ?',
                    $_REQUEST['gateways'],
                );
            }
            ...
            if (
                isset($_REQUEST['massAction']) &&
                $_REQUEST['massAction'] == 'setdefault' &&
                isset($_REQUEST['gateways']) &&
                is_array($_REQUEST['gateways'])
            ) {
                $gatewayID = array_shift($_REQUEST['gateways']);
                $db->Query(
                    'UPDATE {pre}modfax_prefs SET `default_faxgateid`=?',
                    $gatewayID,
                );
            ...
            $gateways = [];
            $res = $db->Query(
                'SELECT `faxgateid`,`title`,`protocol` FROM {pre}modfax_gateways ORDER BY `title` ASC',
            );
            while ($row = $res->FetchArray(MYSQLI_ASSOC)) {
                $row['default'] =
                    $this->prefs['default_faxgateid'] == $row['faxgateid'];
            ...
            $tpl->assign(
                'page',
                $this->_templatePath('modfax.admin.gateways.tpl'),
            );
        } elseif ($_REQUEST['do'] == 'edit' && isset($_REQUEST['id'])) {
            if (isset($_REQUEST['save']) && isset($_REQUEST['id'])) {
                $prefs = $statusPrefs = [];
                $protocol = $statusMode = 0;
                ...
                $db->Query(
                    'UPDATE {pre}modfax_gateways SET `title`=?,`number_format`=?,`status_mode`=?,`status_prefs`=?,`protocol`=?,`prefs`=?,`user`=?,`pass`=? WHERE `faxgateid`=?',
                    $_REQUEST['title'],
                    (int) $_REQUEST['number_format'],
                    $statusMode,
                    serialize($statusPrefs),
            ...
            // fetch
            $res = $db->Query(
                'SELECT * FROM {pre}modfax_gateways WHERE `faxgateid`=?',
                $_REQUEST['id'],
            );
            if ($res->RowCount() == 0) {
                die();
            ...
            $tpl->assign(
                'page',
                $this->_templatePath('modfax.admin.gateways.edit.tpl'),
            );
        }
    }
    ...
    function _add2Stat($type, $count = 1) {
        ...
        $res = $db->Query(
            'SELECT `statid` FROM {pre}modfax_stats WHERE `d`=? AND `m`=? AND `y`=? AND `type`=? LIMIT 1',
            $d,
            $m,
            $y,
            $type,
        ...
        if ($id != 0) {
            $db->Query(
                'UPDATE {pre}modfax_stats SET `count`=`count`+' .
                    (int) $count .
                    ' WHERE `statid`=?',
                $id,
            );
        ...
        // ...or insert new row
            ...
            $db->Query(
                'INSERT INTO {pre}modfax_stats(`d`,`m`,`y`,`type`,`count`) VALUES(?,?,?,?,?)',
                $d,
                $m,
                $y,
                $type,
    ...
    function _getSignature($groupID) {
        ...
        $res = $db->Query(
            'SELECT * FROM {pre}modfax_signatures ' .
    ...
    function _incSignatureCounter($signatureID) {
        ...
        $db->Query(
            'UPDATE {pre}modfax_signatures SET `counter`=`counter`+1 WHERE `signatureid`=?',
            $signatureID,
        );
    }
    ...
    function _processStatusReport($statusCode, $success) {
        ...
        $res = $db->Query(
            'SELECT `pages`,`userid`,`price`,`faxid`,`statuscode`,`refunded` FROM {pre}modfax_outbox WHERE `statuscode`=? AND `status`=?',
            $statusCode,
        ...
        if ($res->RowCount() == 1) {
            ...
            if ($faxStatus == MODFAX_STATUS_ERROR) {
                ...
                if ($this->prefs['refund_on_error'] && !$refunded) {
                    ...
                    PutLog(
                        sprintf(
                            'Refunded <%d> credits to user <%s> (#%d) because the gateway failed to send fax <%d> (statusCode: %s)',
                            $faxPrice,
            ...
            // update outbox entry
            $db->Query(
                'UPDATE {pre}modfax_outbox SET `status`=?,`refunded`=? WHERE `statuscode`=?',
                $faxStatus,
                $refunded ? 1 : 0,
                $statusCode,
            );
            ...
            // update stats
            $this->_add2Stat(
                $success ? MODFAX_EVENT_FAX_OK : MODFAX_EVENT_FAX_ERROR,
            );

            // log
            PutLog(
                sprintf(
                    'Received status report for fax <%d> of user <%d> (statusCode: %s)',
                    $faxID,
                    $userID,
                    $statusCode,
                ),
    ...
    function _formatNo($no, $how = 1) {
        ...
        } elseif ($how == MODFAX_NUMBER_INTERNAT_PLUS) {
            return sprintf('+%02d%s', $no['countryPrefix'], $no['no']);
        } elseif ($how == MODFAX_NUMBER_INTERNAT_NONE) {
            return sprintf('%02d%s', $no['countryPrefix'], $no['no']);
        } elseif ($how == MODFAX_NUMBER_NAT) {
     ...
     * @return bool
     */
    function _sendFaxThroughHTTPGateway(
        $gateway,
        $userMail,
        $fileName,
        $fromName,
        ...
        $request = str_replace(
            '%%user%%',
            urlencode($gateway['user']),
            $request,
        );
        $request = str_replace(
            '%%pass%%',
            urlencode($gateway['pass']),
            $request,
        );
        ...
        if (strpos($response, $gateway['prefs']['returnvalue']) !== false) {
            // status code?
            if (
                preg_match('/Status\:([0-9]*)/', $response, $reg) &&
                is_array($reg) &&
                isset($reg[1])
            ) {
                $statusCode = $reg[1];
     ...
     * @return bool
     */
    function _sendFaxThroughEMailGateway(
        $gateway,
        $userMail,
        $fileName,
        $fromName,
        ...
        if ($pageCount > 0) {
            ...
            if ($faxPrice !== false) {
                ...
                if ($balance < $faxPrice) {
                    PutLog(
                        sprintf(
                            'Failed to send fax from "%s" <%s> (user %d) to <%s>: Not enough credits',
                            $fromName,
                            $fromNo,
                            $userRow['id'],
                            $this->_formatNo($to),
                    ...
                    if ($gateway) {
                        $statusCode = 0;
                        if ($gateway['protocol'] == MODFAX_PROTOCOL_EMAIL) {
                            $result = $this->_sendFaxThroughEMailGateway(
                                $gateway,
                                $userObject->_row['email'],
                                $tempFileName,
                                $fromName,
                            ...
                            $gateway['protocol'] == MODFAX_PROTOCOL_HTTP
                        ) {
                            $result = $this->_sendFaxThroughHTTPGateway(
                                $gateway,
                                $userObject->_row['email'],
                                $tempFileName,
                                $fromName,
                        ...
                        if ($result) {
                            ...
                            $webdisk = _new('BMWebdisk', [$userObject->_id]);
                            if (
                                $webdisk->GetSpaceLimit() == -1 ||
                                $webdisk->GetUsedSpace() +
                                    filesize($tempFileName) <=
                                    $webdisk->GetSpaceLimit()
                            ) {
                                // folder?
                                $folderID = $webdisk->FolderExists(
                                    0,
                                    $lang_user['modfax_sentfolder'],
                                );
                                if (!$folderID) {
                                    $folderID = $webdisk->CreateFolder(
                                        0,
                                        $lang_user['modfax_sentfolder'],
                                    );
                                }
                                ...
                                // store file
                                $diskFileID = $webdisk->CreateFile(
                                    $folderID,
                                    sprintf('fax-%d.pdf', time()),
                                    'application/pdf',
                                    filesize($tempFileName),
                                );
                                if ($diskFileID > 0) {
                            ...
                            // add to outbox
                            $db->Query(
                                'INSERT INTO {pre}modfax_outbox(`userid`,`faxgateid`,`fromname`,`fromno`,`tono`,`pages`,`date`,`diskfileid`,`outboxid`,`price`,`statuscode`,`status`) ' .
                                    'VALUES(?,?,?,?,?,?,?,?,?,?,?,?)',
                                $userObject->_id,
                                $gateway['faxgateid'],
                                $fromName,
                            ...
                            PutLog(
                                sprintf(
                                    'Sent fax from "%s" <%s> (user %d) to <%s> (user: <%s> (#%d); gateway: %d; statusCode: %s; price: %d)',
                                    $fromName,
                                    $fromNo,
                                    $userObject->_id,
                                    $this->_formatNo($to),
                        ...
                        PutLog(
                            sprintf(
                                'Failed to send fax from "%s" <%s> (user %d) to <%s>: Fax gateway <%d> not found',
                                $fromName,
                                $fromNo,
                                $userObject->_id,
                                $this->_formatNo($to),
    ...
    function _calculatePrice($to, $pages, &$faxgateID) {
        ...
        $res = $db->Query(
            'SELECT `prefix`,`faxgateid`,`price_firstpage`,`price_nextpages` FROM {pre}modfax_prefixes WHERE (`country_prefix`=? OR `country_prefix`=?) ORDER BY `country_prefix` DESC, `prefix` DESC',
            $to['countryPrefix'],
            '*',
        );
        while ($row = $res->FetchArray(MYSQLI_ASSOC)) {
    ...
    function _parseNo($no) {
        ...
        // country prefix with +
        elseif (strlen($no) > 4 && preg_match('/^\+/', $no)) {
            $result = [
    ...
    function _generatePDF(
        ...
        if (is_array($blocks)) {
            foreach ($blocks as $block) {
                ...
                if (
                    $block['type'] != MODFAX_BLOCK_PDFFILE &&
                    $this->_needNewPage
                ) {
                    $pdf->AddPage();
     ...
     */
    function _generatePDF_Block_Cover(
        &$pdf,
        $block,
        $fromName,
        $fromNo,
        ...
        $pdf->Cell(
            0,
            $lineHeight * 2,
            $this->_pdfStr($lang_user['modfax_fax']),
            0,
            1,
            'R',
            false,
        ...
        if ($pageCount > 0) {
            ...
            $pdf->Cell(
                20,
                $lineHeight,
                $this->_pdfStr($lang_user['modfax_pages'] . ':'),
                0,
                0,
                'L',
                false,
        ...
        $pdf->Cell(
            20,
            $lineHeight,
            $this->_pdfStr($lang_user['subject'] . ':'),
            0,
            0,
            'L',
            false,
        ...
        for (
            $i = MODFAX_REMARK_URGENT;
            $i <= MODFAX_REMARK_FORINFORMATION;
            $i++
        ) {
            $pdf->SetX($pdf->GetX() + 2);
            $rectX = $pdf->GetX();
            ...
            $pdf->Cell(
                48,
                $lineHeight,
                $this->_pdfStr($lang_user['modfax_remark' . $i]),
                0,
                0,
                'L',
                false,
            ...
            if (
                isset($data['remark']) &&
                is_array($data['remark']) &&
                in_array($i, $data['remark'])
            ) {
                $pdf->Line(
                    $rectX,
                    $rectY,
    ...
    function _generatePDF_Block_Text(&$pdf, $block) {
        ...
        $fontName = in_array($data['fontname'], ['arial', 'courier', 'times'])
            ? $data['fontname']
            : 'courier';
    ...
    function _ensureFPDFisLoaded() {
        ...
        if (!class_exists('FPDF')) {
            if (!@include $this->_fpdfDir . 'fpdf.php') {
                PutLog(
                    sprintf(
                        'Fax plugin: Cannot include FPDF file <%s> - ensure FPDF is installed properly',
        ...
        if (!class_exists('Fpdi')) {
            if (!@include $this->_fpdfDir . 'fpdi/src/autoload.php') {
                PutLog(
                    sprintf(
                        'Fax plugin: Cannot include FPDI file <%s> - ensure FPDI is installed properly',
    ...
    function _pdfStr($in) {
        ...
        if (
            in_array(strtolower($urrentCharset), ['utf8', 'utf-8']) &&
    ...
    class FPDI_FaxPlugin extends FPDI {
        ...
        function _signatureIsForThisPage() {
            if (
                ...
                if (
                    $this->PageNo() == 1 &&
                    $this->signatureArray['showon'] & MODFAX_SHOWON_FIRSTPAGE
                ) {
                    return true;
                } elseif (
                    $this->PageNo() > 1 &&
                    $this->signatureArray['showon'] & MODFAX_SHOWON_OTHERPAGES
                ) {
                    return true;
                }
            }
        ...
        function _placeSignature() {
            ...
            if (
                ($this->signatureArray['style'] & MODFAX_STYLE_BOTTOMLINE) !=
                0
            ) {
                $border .= 'B';
            }
            ...
            if (
                ($this->signatureArray['style'] & MODFAX_STYLE_UNDERLINED) !=
                0
            ) {
                $style .= 'U';
            }
