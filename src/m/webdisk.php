...
if ($_REQUEST['action'] == 'folder') {
    ...
    if (
        ...
        if (
            ...
            $tpl->assign(
                'backLink',
                'webdisk.php?folder=' . $folderID . '&sid=' . session_id(),
            );
 ...
 */ elseif (
    ...
    if ($_REQUEST['type'] == WEBDISK_ITEM_FOLDER) {
        ...
        if ($item) {
            $item['ext'] =
                $item['share'] == 'yes' ? '.SHAREDFOLDER' : '.FOLDER';
