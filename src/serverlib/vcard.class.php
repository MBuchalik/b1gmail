    ...
    function Parse() {
        ...
        while (is_resource($this->_fp) && !feof($this->_fp)) {
            ...
            if ($dPos !== false) {
                ...
                $value = $this->_parseValueField(
                    trim(substr($line, $dPos + 1)),
                );
                ...
                if ($key['name'] == 'N') {
                    ...
                    $anrede = $value[3];
                    if (
                        strtoupper($anrede) == 'MR.' ||
                        strtoupper($anrede) == 'MR'
                    ) {
                        $anrede = 'herr';
                    } elseif (
                        strtoupper($anrede) == 'MS.' ||
                        strtoupper($anrede) == 'MS' ||
                        strtoupper($anrede) == 'MRS.' ||
                        strtoupper($anrede) == 'MRS'
                    ) {
                        $anrede = 'frau';
                    } else {
                ...
                elseif ($key['name'] == 'EMAIL') {
                    $prefix = '';
                    if (
                        isset($key['parameters']['TYPE']) &&
                        eqOrIn($key['parameters']['TYPE'], 'WORK')
                    ) {
                        $prefix = 'work_';
                    }
