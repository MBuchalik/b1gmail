...
class BMCaptchaProvider_reCAPTCHA extends BMAbstractCaptchaProvider {
    ...
    public function check($release = true) {
        ...
        if (
            isset($_SESSION['reCAPTCHAverify']) &&
            is_array($_SESSION['reCAPTCHAverify']) &&
        ...
        PutLog(
            sprintf('reCAPTCHA response data: "%s"', $resp),
            PRIO_DEBUG,
            __FILE__,
            __LINE__,
        );
