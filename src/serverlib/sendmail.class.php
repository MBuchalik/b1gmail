...
class BMSendMail {
    ...
    function SetMailFrom($sender) {
        PutLog(
            sprintf(
                'Differing mail from address set: <%s>',
                ExtractMailAddress($sender),
            ),
            PRIO_DEBUG,
            __FILE__,
            __LINE__,
    ...
    function _sendUsingSendmail() {
        ...
        $command = sprintf(
            ...
            addslashes(
                $this->_mailFrom !== false ? $this->_mailFrom : $this->_sender,
            ),
        ...
        if (!is_resource($fp)) {
            PutLog(
                sprintf('Failed to execute sendmail command <%s>', $command),
                PRIO_WARNING,
                __FILE__,
                __LINE__,
            );
